...
dir={local === "ar" ? "rtl" : "ltr"}
      title={
        <div className="flex flex-col w-[1213px] lg:flex-row gap-0 lg:gap-[113px] px-6 ">
          <div className="w-full lg:w-[500px] text-text-accent text-[16px] font-semibold">{t("Identification")}</div>
          <div className="w-full lg:w-[500px] text-text-accent text-[16px] font-semibold">{t("Assign")}</div>
        </div>
      }
      initiallyOpen={true}
      onOpenChange={(open) => handleToggle("clinicInfo", open)}
      content={
        <div className="relative w-full bg-surface-default rounded-2xl pl-6 pr-6">
          <div className="flex flex-col lg:flex-row gap-0 lg:gap-[3px]">
            {/* Left Column */}
            <div className="flex flex-col gap-4 w-full lg:w-[500px]">
              {/* Services Name */}
              <div className="flex gap-6 items-start min-h-[54px]">
                <div className="w-[180px] text-text-primary font-semibold text-[16px]"> {t("Services Name")}</div>
                <input
                  type="text"
              ...
              {/* Service Category */}
              <div className="flex gap-6 items-start min-h-[54px]">
                <div className="w-[180px] text-text-primary font-semibold text-[16px]">{t("Service Category")}</div>
                <select
                  className="w-[360px] h-[48px] border bg-background-secondary border-bg-border-light rounded-[4px] px-3 text-[14px]"
                  value={formData.serviceCategory}
                  onChange={(e) => handleChange("serviceCategory", e.target.value)}
                >
                  <option value="Medical Examination">{t("Medical Examination")}</option>
              ...
              <div className="flex gap-6 items-start">
                <div className="w-[180px] text-text-primary font-semibold text-[16px]">{t("Service Description")}</div>
                <textarea
            ...
            <div className="flex flex-col gap-4 w-full lg:w-[500px]">
              {/* Assign Complex */}
              <div className="flex gap-6 items-start min-h-[54px]">
                <div className="w-[180px] text-text-primary font-semibold text-[16px]">{t("Assign Complex")}</div>
                <select
                  className="w-[360px] h-[48px] border bg-background-secondary border-bg-border-light rounded-[4px] px-3 text-[14px]"
              ...
              {/* Assign Clinics */}
              <div className="flex gap-6 items-start min-h-[54px]">
                <div className="w-[180px] text-text-primary font-semibold text-[16px]">  {t("Assign Clinics")} </div>
                <select
                  className="w-[360px] h-[48px] border bg-background-secondary border-bg-border-light rounded-[4px] px-3 text-[14px]"
                  value={formData.assignClinics}
                  onChange={(e) => handleChange("assignClinics", e.target.value)}
                >
                  <option value="Internal Medicine, Family Medicine"> {t("Internal Medicine, Family Medicine")}  </option>
              ...
              {/* Required Equipment */}
              <div className="flex gap-6 items-start">
                <div className="w-[180px] text-text-primary font-semibold text-[16px]">{t("Required Equipment")}</div>
                <textarea
                  className="w-[360px] h-[170px] border bg-background-secondary border-bg-border-light rounded-[4px] px-3 py-2 text-[14px] resize-y"
            ...
            <TableRow key={session.no} className="border-b border-[#e4e2dd] h-[54px]">
              ...
              <TableCell className="text-center text-[14px] font-semibold borerder-r border-[#e4e2dd]">
                <input
                  ...
                  className="w-[119px] h-[34px]  text-center border bg-background-secondary border-bg-border-light rounded-[4px] px-3 text-[14px]"
                />
              </TableCell>
              ...
              <TableCell className="text-center text-[14px] font-semibold w-80">
                <input
                  ...
                  className="w-[272px] h-[34px]  text-center border bg-background-secondary border-bg-border-light rounded-[4px] px-3 text-[14px]"
                />
              </TableCell>
...
/>
      ...
      {/* Add button */}
      <div className="text-text-inverse">
        <div className="grid text-end items-end justify-end m-5">
