  ...
  return (
    <div className="flex h-screen  w-screen">
      ...
      <div className="flex flex-col w-full overflow-hidden min-h-screen items-start gap-4 py-4 pl-0 pr-5">
        <Header
          MainTitle="Doctors"
          SubTitle="View Doctor details"
          onOpenSidebar={onOpenSidebar}
          backTo="/ViewDoctorList"
        />
          ...
          <CardContent className="w-full overflow-y-auto scroll-x-hidden pr-[20px] ">
            <main className="flex flex-col gap-[20px] w-full items-end rounded-2xl">
                ...
                <Button
                  onClick={() => {
                    navigate(
                      ...
                      { state: { from: "/ViewDoctorList/ViewDoctorDetails" } }
                    );
                  }}
                  className="
              ...
              <div className="flex flex-col xl:flex-row gap-4 sm:gap-5 w-full max-w-full">
                ...
                >
                  <Card
                    className={`flex flex-col items-center w-full bg-background-primary rounded-[16px] p-[16px]
                          ...
                          <div className="flex flex-col lg:flex-row gap-1">
                            ...
                            <div className="flex-1 text-sm">
                              <p className="break-words">
                                View All Clinics and Departments, Manage Staff
                                Accounts, Access Reports and Analytics, Manage
                                Appointments, Approve/Reject Requests, Configure
                                System Settings, Assign Roles and Permissions,
                                View Billing and Financial Reports, Internal
