                      ...
                      <div className="flex flex-col lg:flex-row flex-wrap gap-[min(70px,4vw)] mt-4 w-full">
                        ...
                        <div className="flex flex-col gap-[min(70px,4vw) flex-1 min-w-0">
                          {[
                            ...
                            <div key={idx} className="flex flex-col sm:flex-row gap-[min(70px,4vw)  items-start min-w-0">
                        ...
                        <div className="flex flex-col gap-4 flex-1 min-w-0">
                          {[
                            { label: 'Account Status', value: <Badge className="bg-secondary-light text-secondary-dark rounded-[20px] w-[92px] justify-center">{t('Active')}</Badge> },
                            { label: 'Account Creation Date', value: `${t('April')} 28, 2024` },
                            { label: 'Last Modified Date', value: `${t('April')} 28, 2025` },
                            { label: 'Last Login Date & Time', value: `${t('May')} 22, 2025 | 23:49` },
                          ].map((item, idx) => (
                            <div key={idx} className="flex flex-col sm:flex-row gap-[min(70px,4vw)] items-start min-w-0">
...
`}>
              ...
              <div className={` relative w-full max-w-full gap-[16px] ${isMobile && !isOpen1 ? "grid" : "flex"} `}>
                ...
                <aside className="flex-1 gap-[16px]" >
                  ...
                  {(isMobile) && (<Card className={`flex flex-col items-center gap-[16px] mb-5 w-full bg-background-primary rounded-[16px] p-[16px]
              ...
              `}
                    ...
                    >
                      ...
                      <section className="flex flex-col items-center justify-center gap-[24px] h-[208px]">
                        ...
                        <div>
                          ...
                          <div className="flex items-center justify-center gap-[6px] mt-[6px]">
                            <span className="font-lato font-regular text-[12px] leading-[130%] tracking-[0] text-text-secondary">
                              US-001
                            </span>
                            <div className=" w-[4px] h-[4px] bg-border-light rounded-sm" />
                            <span className="font-lato font-regular text-[clamp(12px,2vw,14px)]  leading-[130%] tracking-[0] text-text-primary">
                  ...
                  {isMobile && (
                    <Card
                      className={`
      flex flex-col bg-background-primary rounded-[16px] mb-5  p-[16px]
      transition-all duration-300 overflow-hidden
      ${isMobile && !isOpen5 ? "h-[60px] w-full" : "h-auto w-full"}
    `}
                    >
                      {/* عنوان الكارد + زر الفتح/الإغلاق على الموبايل */}
                      <div
                            ...
                            {isOpen5 ? (
                              ...
                              >
                                <path
                                  fillRule="evenodd"
                                  clipRule="evenodd"
                                  d="M13.5303 7.78033C13.2374 8.07322 12.7626 8.07322 12.4697 7.78033L7 2.31066L1.53033 7.78033C1.23744 8.07322 0.762562 8.07322 0.469669 7.78033C0.176777 7.48744 0.176777 7.01256 0.469669 6.71967L6.46967 0.71967C6.76256 0.426776 7.23744 0.426776 7.53033 0.71967L13.5303 6.71967C13.8232 7.01256 13.8232 7.48744 13.5303 7.78033Z"
                                  fill="#414651"
                                />
                              </svg>
                            ) : (
                              <ChevronDownIcon className="w-5 h-5 sm:w-5 sm:h-5 md:w-6 md:h-6 lg:w-7 lg:h-7 text-text-primary" />
                            )}
                          </span>
                        )}
                      </div>

                      <section className="flex flex-col gap-[16px] pt-[24px] pb-[42px] px-[12px] h-[282px]">
                        <div className="inline-flex flex-col items-start gap-4 px-[4px]">
                          {personalInfoData.map((item, index) => (
        ...
        flex flex-col bg-background-primary rounded-[16px] mb-5  p-[16px]
        transition-all duration-300 overflow-hidden
        ${isMobile && !isOpen7 ? "h-[60px] w-full" : "h-auto w-full"}
      `}
                    >
                      {/* عنوان الكارد + زر الفتح/الإغلاق على الموبايل */}
                      <div
        ...
        flex flex-col bg-background-primary rounded-[16px]  p-[16px]
        transition-all duration-300 overflow-hidden
        ${isMobile && !isOpen6 ? "h-[60px] w-full" : "h-auto w-full"}
      `}
                    >
                      {/* عنوان الكارد + زر الفتح/الإغلاق على الموبايل */}
                      <div
