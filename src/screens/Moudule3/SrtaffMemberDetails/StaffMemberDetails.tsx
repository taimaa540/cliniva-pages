  ...
  return (
    <div className="flex h-screen  w-screen">
      ...
      <div className="flex flex-col w-full overflow-hidden min-h-screen items-start gap-4 py-4 pl-0 pr-5">
        <Header
          MainTitle="Staff"
          SubTitle="Edit Staff Member Details"
          onOpenSidebar={onOpenSidebar}
          backTo={backTo}
        />
        ...
        <main className="flex flex-col h-full items-start gap-5 p-[20px] pr-0 relative w-full rounded-2xl overflow-hidden bg-background-tertiary">
          <div className="flex flex-col gap-[20px] w-full overflow-y-auto scroll-x-hidden pr-[20px]">
            <div
              className="flex gap-[14px]  justify-end p-3 items-end text-end pb-2 sm:pb-3 md:pb-3 lg:pb-4 "
              dir={local === "ar" ? "rtl" : "ltr"}
            >
              <Link to={backTo}>
                <button
                  className="     w-[80px] h-[30px]       /* الموبايل الافتراضي */
    ...
    lg:w-[200px] lg:h-[40px]  rounded-[20px] bg-secondary-dark font-lato font-medium text-[clamp(12px,1.1vw,14px)]leading-[100%] tracking-[0] text-surface-primary"
              >
                {t("Save")}
              </button>
            </div>
                ...
                >
                  ...
                  <CollapsibleContent className="w-full">
                    <div className="flex flex-col  gap-[16px]">
                      <h3 className="font-lato font-semibold text-[clamp(12px,1.1vw,14px)]leading-[125%] tracking-[0] text-secondary-dark">
                      ...
                      <div className="grid grid-cols-1 lg:grid-cols-2 gap-[22px]">
                        ...
                        <div className="flex flex-col sm:flex-row sm:items-center   gap-y-2 ">
                          ...
                          <Input
                            ...
                            className="w-[min(100%,360px)] h-10 sm:h-10 md:h-12  bg-background-secondary border border-border-light rounded-[4px] font-lato font-semibold text-[clamp(12px,1.1vw,14px)] leading-[125%] tracking-[0] text-text-primary"
                          />
                        </div>
                        <div className="flex items-center gap-[20px]  ">
                          ...
                          <input
                            ...
                            defaultChecked
                          />
                          <label className="font-lato font-regular text-[clamp(12px,1.1vw,14px)] leading-[154%] tracking-[0] text-text-primary">
                            Male
                          </label>
                          <input
                            className="w-5 h-5"
                        ...
                        <div className="flex flex-col sm:flex-row sm:items-center  gap-y-2 ">
                          ...
                          >
                            <SelectTrigger className="w-[min(100%,360px)] h-10 sm:h-10 md:h-12 bg-background-secondary border border-border-light rounded-[4px] font-lato font-semibold text-[clamp(12px,1.1vw,14px)] leading-[125%] tracking-[0] text-text-primary">
                              <SelectValue />
                            </SelectTrigger>
                            <SelectContent>
                        ...
                        <div className=" flex gap-x-[53px]  flex-wrap  ">
                          <div className=" w-full   sm:w-[560px] gap-y-2 rounded-md py-1">
                            ...
                            <div className="flex  items-start flex-col  sm:flex-row  ">
                              {" "}
                              {/* Label + Icon */}{" "}
                              <div className="flex sm:w-[166px] items-center text-center pb-9 gap-x-2">
                              ...
                              <div className="relative w-full ">
                                ...
                                <div className="flex text-secondary-dark justify-end p-2 max-w-[360px]">
                                  <PlusIcon className="w-5 h-5 sm:w-6 sm:h-6 md:w-7 md:h-7 cursor-pointer" />{" "}
                                </div>{" "}
                              </div>{" "}
                            </div>
                            {/* Plus Icon */}
                          ...
                          <div className="flex flex-col sm:flex-row items-start sm:items-center   h-12 gap-y-2 ">
                            {/* Label + Icon */}
                            ...
                            {/* Input */}
                            <div className="  flex   text-text-primary  font-lato">
                              <label className="   font-lato  text-text-primary font-semibold w-[min(100%,360px)] pt-4 text-[clamp(12px,1.1vw,14px)] h-10 sm:h-10 md:h-12 ">
                        ...
                        <div className="flex flex-col md:flex-row md:items-start lg:items-start  mt-3 gap-3">
                          ...
                          <div className="grid gap-4 w-full grid-cols-2 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 ">
                            {addressFields.map((field, index) => (
                              <Input
                                key={index}
                                className={`${field.width} w-[min(100%,172px)] h-10 sm:h-10 md:h-12 text-[clamp(12px,1.1vw,14px)] placeholder:text-[clamp(12px,1.1vw,14px)]  bg-background-secondary border border-border-light rounded-[4px] font-lato font-semibold  leading-[125%] tracking-[0] text-text-primary`}
                  ...
                  <CollapsibleContent>
                    <div className="flex flex-col items-start gap-4 mt-[20px] ">
                      <div className="flex flex-col md:flex-row gap-6 w-full">
                        {/* Job Title */}
                        <div
                          className="flex flex-col sm:flex-row sm:items-center h-12 gap-x-4 
                  flex-[1_1_1px] max-w-full"
                        >
                          <Label
                            className="sm:w-[165px] font-lato font-semibold 
                  ...
                  <CollapsibleContent>
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-4 gap-y-6 mt-5">
                      {documents.map((doc, index) => (
                        <>
                          {/* العمود الأول: Label + FileUpload */}
                          <div className="flex flex-col lg:flex-row gap-y-2 w-auto">
                            <Label className="font-lato font-semibold w-[250px] text-[clamp(14px,1.1vw,16px)]leading-[124%] text-text-primary">
                              {t(`${doc.label}`)}
                            </Label>
