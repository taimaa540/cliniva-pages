                  ...
                  <div className="flex flex-col  gap-[16px]">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-[22px]">
                      <div className="flex flex-col sm:flex-row items-start w-full">
                        <Label className="sm:w-[165px] font-lato font-semibold text-base leading-[124%] tracking-[0] text-text-primary">
                          {t("Profile Picture")}
                        </Label>
                     ...
                     <div className=" w-full   sm:w-[560px] gap-y-2 rounded-md py-1">
                        ...
                        <div className="flex flex-col sm:flex-row items-start sm:items-center   h-12 gap-y-2 ">
                          ...
                          <div className="flex items-center gap-2 sm:w-[166px] h-6 flex-shrink-0">
                            ...
                            <span className="min-sm:w-[165px] text-text-primary font-semibold text-[clamp(16px,1.1vw,16px)] leading-6">
                              {t("Email")}:
                            </span>
                          </div>
                      ...
                      <div className="flex flex-col md:flex-row md:items-start lg:items-start   gap-3">
                        <div className="flex w-[186px] items-center gap-4 mt-2">
                          ...
                          <div className="min-sm:w-[165px] text-text-primary font-semibold text-[clamp(16px,1.1vw,16px)]">
                            {t("Physical Address")}:
                          </div >
                        </div>
