...
const formFields = (t: (key: string) => string) => ({
    ...
    emergencyNumber: { label: t("Emergency Contact Number"), placeholder: t("Enter emergency phone number") },
                                ...
                                <div className="grid grid-cols-2 gap-8 px-4 ">
                                    ...
                                    <div className="flex flex-col items-start gap-6">
                                        ...
                                        <div className="flex self-stretch w-full items-center gap-8 relative">
                                            ...
                                            <Input
                                                className="w-[360px] h-12 bg-base-white border-[#d5d6d9] shadow-shadow-xs"
                                        ...
                                        <div className="flex self-stretch w-full items-center gap-8 relative">
                                            ...
                                            >
                                                ...
                                                <SelectTrigger className="w-[360px] h-12 bg-base-white border-[#d5d6d9] shadow-shadow-xs" dir={local === 'ar' ? 'rtl' : 'ltr'}>
                                        ...
                                        <div className="flex self-stretch w-full items-center gap-8 relative">
                                            ...
                                            <Select
                                                ...
                                                onValueChange={val => handleInputChange('preferredLanguage', val)}
                                            >
                                        ...
                                        <div className="flex items-start gap-8 w-full">
                                            ...
                                            <div className="flex w-[360px] h-12 items-center justify-between bg-base-white rounded border border-[#d5d6d9] shadow-shadow-xs px-4">
                                                <input
                                                    type="text"
...
<h1 className=" text-[16px] font-semibold text-center justify-center" style={{ color: "rgba(217, 45, 32, 1)" }}> Card Number is incorrect or not registered with insurance.</h1>
                                        </div>
                                    ...
                                    <Button className="flex w-[122px] h-[42px] items-center justify-center gap-1 mt-4 rounded-[20px] border border-solid border-[#00b48d] bg-transparent hover:bg-transparent h-auto">
                                        ...
                                        <div className="inline-flex items-center gap-2.5 p-0.5 relative flex-[0_0_auto]">
                                            <div className="mt-[-1.00px] font-normal text-secondary-dark text-sm leading-[14px] relative w-fit [font-family:'Lato',Helvetica] text-center tracking-[0] whitespace-nowrap">
                                                <span style={{ cursor: "pointer" }} onClick={handleGetData}>
                                                    {t("Get Data")}
                                                </span>
                                            </div>
                                        </div>
...
{showDefaultValues && (
                            ...
                            <div className="flex flex-col-2 w-full bg-surface-default rounded-2xl  gap-[126px] h-[374px] " dir={local === 'ar' ? 'rtl' : 'ltr'}>
                                ...
                                <div className="grid  gap-y-[30px] ">
                                    <div className="flex gap-[32px] w-[500px]">
                                        <h1 className="w-[155px] text-text-primary font-semibold text-[16px]">Member Number :
                                        </h1>
                                        <h1 className=" text-text-primary font-normal text-[14px]">36884674</h1>
                                    </div>
                                    <div className="flex gap-[32px] w-[500px] items-center">
                                        <h1 className=" w-[190px] text-text-primary font-semibold text-[16px]">Insurance Company  :</h1>
                                    ...
                                    < div className="flex gap-[32px] w-[500px]">
                                        <h1 className="w-[155px] text-text-primary font-semibold text-[16px]">Group Number :</h1>
                                        <h1 className=" text-text-primary font-normal text-[14px]">12345678</h1>
                                    </div>
                                    <div className="flex gap-[32px] w-[500px]">
                                        <h1 className="w-[155px] text-text-primary font-semibold text-[16px]">Policy ID :</h1>
                                        <h1 className=" text-text-primary font-normal text-[14px]">513029001</h1>
                                    </div>
                                    <div className="flex gap-[32px] w-[500px]">
                                        <h1 className="w-[155px] text-text-primary font-semibold text-[16px]">Co-payment :</h1>
                                        <h1 className=" text-text-primary font-normal text-[14px]">% 20.00</h1>
                                    </div>
                                    <div className="flex gap-[32px] w-[500px]">
                                        <h1 className="w-[155px] text-text-primary font-semibold text-[16px]">Coverage Start Date :</h1>
                                        <h1 className=" text-text-primary font-normal text-[14px]">Nov 20,2026</h1>
                                    </div>
                                    <div className="flex gap-[32px] w-[500px]">
                                        <h1 className="w-[155px] text-text-primary font-semibold text-[16px]">Insurance Status :</h1>
                                ...
                                <div className="flex flex-col gap-8 px-4">
                                    <div className="flex gap-[32px] h-[20px] w-[500px]">
                                        <h1 className="w-[155px] text-text-primary font-semibold text-[16px]">Member Type:</h1>
                                        <h1 className="text-text-primary font-normal text-[14px]">Main</h1>
                                    </div>

                                    <div className="flex gap-[32px] h-[20px] w-[500px]">
                                        <h1 className="w-[155px] text-text-primary font-semibold text-[16px]">Provider Network:</h1>
                                        <h1 className="text-text-primary font-normal text-[14px]">300186</h1>
                                    </div>

                                    <div className="flex gap-x-[32px] h-[20px] w-[500px]">
                                        <h1 className="w-[155px] text-text-primary font-semibold text-[16px]">Class:</h1>
                                        <h1 className="text-text-primary font-normal text-[14px]">essential 1.0</h1>
                                    </div>

                                    <div className="flex gap-x-[32px] h-[20px] w-[500px]">
                                        <h1 className="w-[155px] text-text-primary font-semibold text-[16px]">Coverage Limit:</h1>
                                        <h1 className="text-text-primary font-normal text-[14px]">75.00</h1>
                                    </div>

                                    <div className="flex gap-x-[32px] h-[20px] w-[500px]">
                                        <h1 className="w-[155px] text-text-primary font-semibold text-[16px]">Coverage End Date:</h1>
                                        <h1 className="text-text-primary font-normal text-[14px]">Nov 20,2026</h1>
                                    </div>
                                </div>
                    ...
                    <ReusableCollapsible
                        ...
                        dir={local === 'ar' ? 'rtl' : 'ltr'}
                        content={
                            <div className="relative w-full h-[496px] bg-surface-default rounded-2x" >
                                <div className="flex flex-col gap-[16px]">
                                    <div className="grid grid-cols-2 gap-[22px]">
                                            ...
                                            <div className="flex items-center gap-[32px] rounded-2xl">
                                                ...
                                                <div className="w-[360px]">
                                                    <PhoneInput
                                                        ...
                                                        style={{ width: '100%', height: '48px', boxSizing: 'border-box', direction: local === 'ar' ? 'rtl' : 'ltr' }}
                                                        className={`bg-background-secondary border !border-border-light !rounded-[4px] font-lato font-semibold text-sm leading-[125%] tracking-[0] text-text-primary ${local === 'ar' ? 'rtl' : 'ltr'}`}
                                                        containerClass="!w-full"
                                                        inputClass={`!w-full !h-12 !border-0 !outline-none !text-text-primary !bg-background-secondary !px-3 ${local === 'ar' ? 'rtl' : 'ltr'}`}
                                                        ...
                                                        placeholder={showDefaultValues ? undefined : formFields(t).phone.placeholder}
                                                        value={showDefaultValues ? defaultFormValues.phoneNumber : undefined}
                                                    />
                                                </div>
                                            </div>
                                        ...
                                        <div className="flex items-start mt-3">
                                            ...
                                            <div className="flex text-text-primary font-sans">
                                                <input
                                                    type="email"
                                                    placeholder={showDefaultValues ? undefined : formFields(t).email.placeholder}
                                                    value={showDefaultValues ? defaultFormValues.email : undefined}
                                                    className="bg-background-secondary border border-border-light rounded-[4px] font-lato font-semibold text-sm leading-[125%] tracking-[0] text-text-primary w-[360px] h-[48px] px-3"
                                                />
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div className="flex items-center gap-8">
                                        ...
                                        {addressFields.map((field, index) => (
                                            <Input
                                                key={index}
                                                value={showDefaultValues ? defaultFormValues.address : undefined}
                                                placeholder={showDefaultValues ? undefined : formFields(t).address.placeholder}
                                                className={`w-[165px] h-[48px] bg-background-secondary border border-border-light rounded-[4px] font-lato font-semibold text-sm leading-[125%] tracking-[0] text-text-primary`}
                                            />
                                        ))}
                                    </div>
                                </div>
                                ...
                                <div className="flex flex-col  gap-[16px]">
                                    <div className="grid grid-cols-2 gap-[22px]">
                                        <div className="flex items-center gap-[32px]">
                                            ...
                                            <Input
                                                value={showDefaultValues ? defaultFormValues.emergencyContact : undefined}
                                                placeholder={showDefaultValues ? undefined : formFields(t).emergencyContact.placeholder}
                                        ...
                                        <div className="flex items-center gap-[32px]">
                                            ...
                                            <Input
                                                value={showDefaultValues ? defaultFormValues.relationship : undefined}
                                                placeholder={showDefaultValues ? undefined : formFields(t).relationship.placeholder}
                                    ...
                                    <div className="flex items-center gap-[32px] rounded-2xl">
                                        ...
                                        <div className="w-[360px] !bg-background-secondary !rounded-[4px] overflow-hidden">
                                            <PhoneInput
                                                value={showDefaultValues ? defaultFormValues.emergencyNumber : undefined}
                                                placeholder={showDefaultValues ? undefined : formFields(t).emergencyNumber.placeholder}
                                                // حذف القيمة الابتدائية
                                                onChange={setValue}
                                                labels={{ ...en, ...shortLabels }}
                                                style={{ width: '100%', height: '48px' }}
                                                className={`border !border-border-light !bg-background-secondary font-lato font-semibold !rounded-[4px] text-sm leading-[125%] tracking-[0] text-text-primary ${local === 'ar' ? 'rtl' : 'ltr'}`}
                                ...
                                <div className="flex items-center  justify-between ">
                                    <div className="inline-flex items-center gap-6">
                                        <div className="inline-flex items-center gap-5 relative flex-[0_0_auto]">
                                            ...
                                            <Input
                                                className="w-[280px] h-12 bg-base-white border-[#d5d6d9] shadow-shadow-xs"
                                        ...
                                        <div className="inline-flex items-center gap-5 relative flex-[0_0_auto]">
                                            ...
                                            <FileUpload
                                                ...
                                                label={
                                                    <>
                                                        <span className="text-primary-default">Click or Drag</span>{" "}
                                                        <span className="text-text-primary">file to this area to upload</span>
                                                    </>
                                                }
                                            />
                                        </div>
                                        ...
                                        <div className="flex items-center gap-4 relative">
                                            <div className="inline-flex items-center gap-5 relative flex-[0_0_auto]">
                                                ...
                                                <div className="flex flex-col w-[280px] h-12 items-center justify-center gap-2 px-3.5 py-2.5 relative bg-base-white rounded overflow-hidden border border-solid border-[#d5d6d9] shadow-shadow-xs">
