...
<div className="flex gap-[14px]  justify-end p-3 items-end text-end pb-2 sm:pb-3 md:pb-3 lg:pb-4 "  dir={local === 'ar' ? 'rtl' : 'ltr'} >
  ...
  <Card className="w-full bg-background-primary rounded-[16px] p-[16px]">
    ...
    <div className="flex flex-col sm:flex-row items-start w-full">
                        <Label className="min-w-[160px] font-lato font-semibold text-base leading-[124%] tracking-[0] text-text-primary">
                          {t("Profile Picture")}
                        </Label>
                        ...
                        <Input
                          ...
                          className="w-[min(100%,360px)] h-9 sm:h-10 md:h-12  bg-background-secondary border border-border-light rounded-[4px] font-lato font-semibold text-sm leading-[125%] tracking-[0] text-text-primary"
                        />
                      </div>
                      ...
                      <div className="text-text-primary font-semibold">
                        ...
                        <Select defaultValue="Sy" dir={local === "en" ? "ltr" : "rtl"}>
                          <SelectTrigger className="w-[min(100%,360px)] h-9 sm:h-10 md:h-12 bg-background-secondary border border-border-light rounded-[4px] font-lato font-semibold text-sm leading-[125%] tracking-[0] text-text-primary">
                            <SelectValue />
                          </SelectTrigger>
                          <SelectContent>
                    ...
                    <div className="flex flex-col ">
                      <div className=" flex gap-x-[53px]  flex-wrap  " >
                        ...
                        <div className="flex flex-col sm:flex-row items-start sm:items-center   h-12 gap-y-2 ">
                          ...
                          <div className="flex items-center gap-2 sm:w-[166px] h-6 flex-shrink-0">
                            ...
                            <span className="min-min-w-[160px] text-text-primary font-semibold text-[clamp(16px,1.1vw,16px)] leading-6">
                              {t("Email")}:
                            </span>
                          </div>
                          ...
                          <div
                            ...
                            <label className="   font-sans  text-text-primary font-semibold w-[min(100%,360px)] h-9 sm:h-10 md:h-12 ">ammarsvu91@gmail.com</label>
                          </div>
                        </div>
                      ...
                      <div className="flex flex-col md:flex-row md:items-start lg:items-start  mt-5 gap-3">
                        <div className="flex w-[186px] items-center gap-4 mt-2">
                          ...
                          <div className="min-min-w-[160px] text-text-primary font-semibold text-[clamp(16px,1.1vw,16px)]">
                            {t("Physical Address")}:
                          </div >
                        </div>
                        <div className="grid gap-4 w-full grid-cols-2 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 ">
                          {addressFields.map((field, index) => (
                            <Input
                              key={index}
                              className={`${field.width} w-[min(100%,172px)] h-9 sm:h-10 md:h-12 text-[clamp(14px,1.1vw,16px)] placeholder:text-[clamp(14px,1.1vw,16px)]  bg-background-secondary border border-border-light rounded-[4px] font-lato font-semibold  leading-[125%] tracking-[0] text-text-primary`}
                    ...
                    <div className="flex flex-col gap-[16px]">
                      <div className="grid grid-cols-1  lg:grid-cols-2  gap-[22px]">
                        <div className="flex flex-col sm:flex-row sm:items-center    gap-y-2 gap-x-8">
                          ...
                          <Input
                            ...
                            className="w-[min(100%,360px)] h-9 sm:h-10 md:h-12 text-[clamp(14px,1.1vw,16px)] placeholder:text-[clamp(14px,1.1vw,16px)]  bg-background-secondary border border-border-light rounded-[4px] font-lato font-semibold  leading-[125%] tracking-[0] text-text-primary"
                          />
                        </div>
                        <div className="flex flex-col sm:flex-row sm:items-center    gap-y-2 gap-x-8">
                          <Label className="min-w-[160px] font-lato font-semibold text-base leading-[124%] tracking-[0] text-text-primary">
                      ...
                      <div className="flex flex-col sm:flex-row sm:items-center   gap-y-2 gap-x-8">
                        ...
                        <div className="w-[min(100%,360px)] h-9 sm:h-10 md:h-12 text-[clamp(14px,1.1vw,16px)] placeholder:text-[clamp(14px,1.1vw,16px)] !bg-background-secondary !rounded-[4px] overflow-hidden  text-text-primary font-semibold">
                          <PhoneInputCustom value={emergencyContact.number}
                            onChange={setValue}
                            placeholder={t("Enter Number")}
                          />
                      ...
                      <div className="flex flex-col sm:flex-row sm:items-center w-full sm:w-[520px]  h-12 gap-y-2 gap-x-8">
                        ...
                        <div className="flex text-text-primary font-semibold">
                          <Input
                            ...
                            className="bg-background-secondary  text-text-primary  border-border-light w-[min(100%,360px)] h-9 sm:h-10 md:h-12 shadow-[0px_1px_2px_0px_#0A0D120D] rounder-[4px]  font-lato font-semibold text-sm leading-[125%] tracking-[0]"
                          /></div>
                      </div>
  ...
  {documents.map((doc, index) => (
    <>
      ...
      <div className="flex flex-col lg:flex-row gap-y-2 w-auto">
        <Label className="font-lato font-semibold w-[250px] text-base leading-[124%] text-text-primary">
          {t(`${doc.label}`)}
        </Label>
