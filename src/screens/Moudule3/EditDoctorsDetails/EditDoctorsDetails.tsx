                  ...
                  <CollapsibleTrigger asChild>
                    ...
                    >
                      <div className="flex w-full items-center justify-between mb-[12px] ">
                        <h2 className="text-primary-default text-[clamp(14px,1.1vw,16px)] font-lato font-bold leading-[124%] tracking-[0] ">
                    ...
                    <div className="flex flex-col  gap-[16px]">
                      ...
                      <div className="flex flex-col ">
                        <div className=" flex gap-x-[53px]  flex-wrap  " >
                          ...
                          <div className=" w-full   sm:w-[560px] gap-y-2 rounded-md py-1">
                            {/* Label + Input */} <div className="flex  items-start flex-col gap-x-2  sm:flex-row  "> {/* Label + Icon */} <div className="flex items-center text-center pt-3 pb-2 gap-x-2">
                          ...
                          <div className="flex flex-col sm:flex-row md:items-center items-start sm:items-center   h-12 gap-y-2 ">
                            {/* Label + Icon */}
                            <div className="flex items-center gap-2 sm:w-[166px] h-6 flex-shrink-0">
                              ...
                              <span className="sm:w-[165px] text-text-primary font-semibold font-lato text-[clamp(14px,1.1vw,16px)] leading-6">
                                {t("Email")}:
                              </span>
                            </div>
                            ...
                            <div
                              ...
                              <label className="   font-lato p-3 text-text-primary font-semibold w-[min(100%,360px)] h-9 sm:h-10 md:h-12 ">ammarsvu91@gmail.com</label>
                            </div>
                          </div>
                        ...
                        <div className="flex flex-col md:flex-row md:items-start lg:items-start  mt-5">
                          <div className="flex w-[186px] items-center gap-2 mt-2">
                            ...
                            <div className="sm:w-[165px] text-text-primary font-semibold font-lato text-[clamp(14px,1.1vw,16px)]">
                              {t("Physical Address")}:
                            </div >
                          </div>
                          <div className="grid gap-4 w-full grid-cols-2 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 ">
                            {addressFields.map((field, index) => (
                              <Input
                                key={index}
                                className={`${field.width} w-[min(100%,172px)] h-9 sm:h-10 md:h-12 text-[clamp(12px,1.1vw,14px)] placeholder:text-[clamp(12px,1.1vw,14px)]  bg-background-secondary border border-border-light rounded-[4px] font-lato font-semibold  leading-[125%] tracking-[0] text-text-primary`}
                      ...
                      <div className="flex flex-col gap-[16px]">
                        <div className="grid grid-cols-1  lg:grid-cols-2  gap-[22px]">
                          <div className="flex flex-col sm:flex-row sm:items-center    gap-y-2 gap-x-6">
                            ...
                            <Input
                              ...
                              className="w-[min(100%,360px)] h-9 sm:h-10 md:h-12 text-[clamp(12px,1.1vw,14px)] placeholder:text-[clamp(12px,1.1vw,14px)]  bg-background-secondary border border-border-light rounded-[4px] font-lato font-semibold  leading-[125%] tracking-[0] text-text-primary"
                            />
                          </div>
                          <div className="flex flex-col sm:flex-row sm:items-center    gap-y-2 gap-x-6">
                            <Label className="sm:w-[165px] font-lato font-semibold font-lato text-[clamp(14px,1.1vw,16px)] leading-[124%] tracking-[0] text-text-primary">
                        ...
                        <div className="flex flex-col sm:flex-row sm:items-center   gap-y-2 gap-x-6">
                          ...
                          <div className="w-[min(100%,360px)] h-9 sm:h-10 md:h-12 text-[clamp(12px,1.1vw,14px)] placeholder:text-[clamp(12px,1.1vw,14px)] !bg-background-secondary !rounded-[4px] overflow-hidden  text-text-primary font-semibold">
                            <PhoneInputCustom value={emergencyContact.number}
                              onChange={setValue}
                              placeholder={t("Enter Number")}
                            />
