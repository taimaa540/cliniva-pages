...
export const UserDetailsSection = ({
  ...
  return (
    ...
    >
      ...
      <Card className={`flex flex-col w-[1197px] h-[866px] items-start gap-5 p-5 mt-[10px] relative self-stretch w-[1197px] flex-[0_0_auto] ${ dark ? "bg-[#272932] border-[white]" : "bg-bg" } rounded-2xl overflow-hidden`}>
