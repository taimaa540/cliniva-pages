      ...
      <Card className="flex flex-col h-full items-start gap-5 p-[20px] pr-0 relative w-full rounded-2xl overflow-hidden bg-background-secondary">
        ...
        <div className="flex justify-between w-full h-[40px] items-center text-center " dir={local === 'ar' ? 'rtl' : 'ltr'} >
                ...
                <div className="inline-flex items-center gap-2.5 " >
                  ...
                  >
                    <SelectTrigger className="inline-flex items-center gap-0.5 pl-2.5 pr-2 py-1.5 bg-secondary-light rounded-[20px] border-0 h-auto w-fit"dir={local === 'ar' ? 'rtl' : 'ltr'} >
                      <SelectValue>
...
<h1 className="text-[11px] font-bold text-text-inverse">{t("Add New Patient")}</h1>
              ...
              <table className="table-fixed w-full rounded-lg text-center border-collapse" dir={local === 'ar' ? 'rtl' : 'ltr'} >
                <thead>
                  <tr className="h-[56px] bg-background-primary border-b border-border-light sticky top-0">
                    ...
                    <td className="w-[15%] font-lato font-bold text-[12px] text-text-primary">{t("Actions")}</td>
                  </tr>
                </thead>
                <tbody>
          ...
          <div className="flex h-[66px] justify-between pl-1 pr-0 py-0 w-full items-center mt-4" dir={local === 'ar' ? 'rtl' : 'ltr'} >
            <div className="flex items-center gap-2.5">
              ...
              <Select defaultValue="10">
                <SelectTrigger className="w-[60px] h-[30px] bg-secondary-light rounded-[20px] border-0 px-2 py-1.5" dir={local === 'ar' ? 'rtl' : 'ltr'} >
              ...
              <span className="font-title-11px-regular w-36 font-[number:var(--title-11px-regular-font-weight)] text-on-surface-secondary text-[length:var(--title-11px-regular-font-size)] tracking-[var(--title-11px-regular-letter-spacing)] leading-[var(--title-11px-regular-line-height)] [font-style:var(--title-11px-regular-font-style)]">
                {t("out of 14")}
              </span>
            </div>
