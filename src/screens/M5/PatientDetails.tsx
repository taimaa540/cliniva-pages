      ...
      <div className="flex flex-col w-full overflow-hidden min-h-screen items-start gap-4 py-4 pl-0 pr-5">
        ...
        <Card className="flex flex-col h-full items-start gap-5 p-[20px] pr-0 relative w-full rounded-2xl overflow-hidden bg-background-tertiary">
          <CardContent className="w-full overflow-y-auto scroll-x-hidden pr-[20px] ">
            <main className="flex flex-col gap-4 sm:gap-5 w-full max-w-full rounded-2xl">
              <div className="flex flex-wrap justify-between gap-y-2">
                <div className="flex gap-[9px] items-center">
                  ...
                  {showDialog && actionType === "deactivate" && (
                    ...
                    >
                      <p>
                        Deactivating a patient will prevent access to services,
                        appointment bookings, and future communications. This
                  ...
                  {showDialog && actionType === "activate" && (
                    ...
                    >
                      <p>
                        Activate the patient will be able to book appointments,
                        receive and access system services.
                      </p>
                    </Activate>
                  )}
                </div>
                ...
                <section className="flex flex-col gap-4 w-full max-w-full min-w-0 flex-1">
                  <Card className="flex flex-col w-full max-w-full bg-background-primary rounded-[16px] p-4 sm:p-4">
                    ...
                    >
                      ...
                      <div className="flex flex-wrap items-start w-full max-[767px]:gap-[20px] gap-[85px] mt-[18px] max-[767px]:flex-col">
                        {/* العمود الأول */}
                        <div className="flex-1 grid grid-cols-2 max-[767px]:grid-cols-1 gap-[32px] max-[767px]:gap-[15px]">
                        ...
                        {/* العمود الثاني */}
                        <div className="flex-1 grid grid-cols-2 max-[767px]:grid-cols-1 gap-x-[32px] gap-y-[42px] max-[767px]:gap-[15px]">
                          <h4 className="font-lato font-semibold text-base leading-[124%] tracking-[0] text-text-primary">
                            {t("Member Type")} :
                          </h4>
                          <h5 className="font-lato font-regular text-sm leading-[125%] tracking-[0] text-text-primary">
