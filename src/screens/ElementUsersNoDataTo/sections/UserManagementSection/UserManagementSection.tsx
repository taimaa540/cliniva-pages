...
export const UserManagementSection = ({
  ...
  const [open, setOpen] = useState({ two: false, three: false });
    ...
    <nav className="h-screen w-[223px] flex flex-col bg-background-primary border border-[red]">
      ...
      <main className="flex flex-col flex-1 items-center mt-5 p-[9px]">
        <section className="w-full space-y-2">
          ...
          <button className="flex items-center w-full h-[40px] gap-2 py-[10px] pl-[4px] rounded justify-start border border-[red]">
            <svg
              width="20"
              height="20"
              viewBox="0 0 20 20"
            ...
            <span className="font-lato font-semibold text-xs leading-[130%] tracking-[0] text-text-secondary">
              {t("Users Management")}
            </span>
          </button>
          <Collapsible
            open={open.two}
            onOpenChange={() => setOpen({ ...open, two: !open.two })}
          >
            <CollapsibleTrigger className="w-full">
              <button className="flex items-center w-full h-[40px] justify-between py-[10px] pl-[4px] rounded justify-start">
            ...
            <div className="w-[205px] h-[124px] bg-background-secondary">
              <h5 className="font-lato font-regular text-xs text-text-secondary leading-[130%] tracking-[0] px-[28px] py-[12px] h-[40px] ">Company Details</h5>
              <h5 className="font-lato font-regular text-xs text-text-secondary leading-[130%] tracking-[0] px-[28px] py-[12px] h-[40px]">Complexes List</h5>
              <h5 className="font-lato font-regular text-xs text-text-secondary leading-[130%] tracking-[0] px-[28px] py-[12px] h-[40px]">Clinics List</h5>
            </div>
            </CollapsibleContent>
          </Collapsible>
          <Collapsible
            open={open.three}
            onOpenChange={() => setOpen({ ...open, three: !open.three })}
          >
            <CollapsibleTrigger className="w-full">
              <button className="flex items-center w-full h-[40px] justify-between py-[10px] pl-[4px] rounded justify-start">
                <div className="flex items-center gap-[8px]">
                ...
                <ChevronDownIcon
                  style={{ width: "14px", height: "14px" }}
                  className={`transition-transform duration-200 ${
                    open.three ? "rotate-180" : "rotate-0"
                  }`}
                />
              </button>
            </CollapsibleTrigger>
          ...
          <button className="flex items-center w-full h-[40px] gap-2 py-[10px] pl-[4px]  rounded justify-start">
            <svg
              width="20"
              height="20"
              viewBox="0 0 20 20"
