 ...
 <div className="px-4 pb-4">
                      ...
                      <div className="grid grid-cols-[auto_150px_1fr] items-center gap-3">
                        <div className="text-text-primary">
                          ...
                          <svg width="21" height="21" viewBox="0 0 22 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M8.07923 0.787741C10.0441 0.737747 11.9541 0.737743 13.9191 0.787741C17.157 0.86974 18.9413 0.915499 20.2843 2.25649C21.6291 3.61147 21.6655 5.34874 21.7325 8.50161C21.7535 9.50858 21.7535 10.4868 21.7325 11.4938C21.6656 14.6463 21.6288 16.3821 20.2872 17.735C18.9422 19.079 17.158 19.1247 13.92 19.2067C12.9381 19.2317 11.9691 19.2448 11.0001 19.2448C10.0312 19.2448 9.06212 19.2317 8.0802 19.2067C4.84234 19.1247 3.05795 19.0788 1.71497 17.7379C0.370009 16.383 0.332745 14.6456 0.265749 11.4928C0.24475 10.4859 0.244751 9.50759 0.265749 8.50063C0.332749 5.34763 0.370038 3.61144 1.71204 2.25844C3.05703 0.914515 4.84128 0.86974 8.07923 0.787741ZM13.881 2.28579C11.9421 2.23579 10.0572 2.2358 8.11731 2.28579C5.07934 2.36279 3.69256 2.39708 2.77356 3.31606C1.85556 4.24206 1.82677 5.58688 1.76477 8.53188C1.74378 9.51674 1.74378 10.4747 1.76477 11.4606C1.82677 14.4055 1.85648 15.7504 2.77747 16.6774C3.69447 17.5932 5.08048 17.6297 8.11829 17.7067C10.0572 17.7567 11.9421 17.7567 13.882 17.7067C16.9199 17.6297 18.3057 17.5944 19.2247 16.6754C20.1427 15.7494 20.1715 14.4055 20.2335 11.4606C20.2545 10.4757 20.2545 9.51775 20.2335 8.53188C20.1715 5.58688 20.1428 4.24111 19.2218 3.31411C18.3048 2.39841 16.9186 2.36278 13.881 2.28579ZM5.35462 6.11098C5.56562 5.75498 6.02596 5.63533 6.38196 5.84633L9.32337 7.58657C10.7954 8.45357 11.2039 8.45357 12.6779 7.58657L15.6183 5.84731C15.9753 5.63631 16.4356 5.75496 16.6456 6.11196C16.8564 6.46883 16.7387 6.92827 16.382 7.13833L13.4396 8.87856C12.4588 9.45643 11.73 9.74466 11.0001 9.74477C10.2711 9.74477 9.54165 9.45556 8.56165 8.87856L5.61829 7.13735C5.26276 6.92627 5.14393 6.46678 5.35462 6.11098Z" fill="CurrentColor" />
                          </svg>
                    ...
                    <div className="flex flex-col gap-8 items-start text-center">
                      ...
                      <div className="grid grid-cols-[auto_150px_1fr] items-center gap-3">
                        ...
                        <div
                          ...
                          className="text-on-surface-primary flex items-center gap-3"
                        ><div className="text-text-primary">
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                              <path fill-rule="evenodd" clip-rule="evenodd" d="M0.0174851 24H2.04576L9.98402 14.6892L16.2962 24H23.2727L13.8657 10.1925L22.5034 0H20.4401L12.939 8.81705L6.92412 0H0L9.09228 13.3666L0.0174851 24ZM2.79762 1.56943H5.92746L20.4576 22.5187H17.2928L2.79762 1.56943Z" fill="CurrentColor" />
                            </svg>
                          </div>
                          {t("       Twitter   ")}:
                        </div>
    ...
    {/* Working Days Collapsible */}
      ...
      <ReusableCollapsible
            ...
            content={<div className="px-4 pb-4">      <div className="bg-surface-default rounded-2xl overflow-hidden">
              <Table>
            ...
            content={<div className="p-0">       <Table>
                    <TableHeader className="">
                      <TableRow>
                        ...
                        <TableHead className="text-center w-56 text-text-praimary font-semibold">
                          {t("User-ID")}
                        </TableHead>
