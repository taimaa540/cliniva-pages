...
export const ElementViewDetailsClinicP3 = (): JSX.Element => {
  ...
  return (
    <div className="flex h-screen  w-screen">
      ...
      >
        <Header
          MainTitle="Medical Clinic Details"
        ...
        <Card className="flex flex-col h-auto items-start gap-6 p-5 mt-[10px] bg-background-tertiary relative self-stretch w-full rounded-2xl overflow-hidden">
          <CardContent className="p-0 w-full overflow-y-auto gap-5 h-auto">
            ...
            >
              <Button
                onClick={(e) => {
                  navigate("/ElementViewClinicP3/ElementEditClincp3", {
                    state: { from: "/ElementViewClinicP3" },
                  });
                }}
                className="
       ...
       `}
            ...
            <ReusableCollapsible
              ...
              content={
                <div>
                  {" "}
                  <div className="w-full h-[332px] bg-[url(/background.png)] bg-cover font-lato bg-center rounded" />
