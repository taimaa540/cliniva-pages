...
export const ContactInfoSectionMobile = ({
  title,
            ...
            <CardContent className="p-0">
              ...
              <div className="flex flex-col items-start gap-6">
                <div className="flex flex-col items-start justify-between relative self-stretch w-full flex-[0_0_auto]">
                  ...
                  <div className="flex flex-col justify-center relative flex-[0_0_auto] items-start gap-8">
                    ...
                    <Input
                      ...
                      className="px-4 py-2 bg-white rounded border border-solid border-[#e4e2dd] [font-family:'Lato',Helvetica] font-normal text-on-surface-secondary text-base tracking-[0] leading-6"
                    />
                  </div>
                </div>

                <div className="flex flex-col gap-[20px] items-center relative self-stretch w-full flex-[0_0_auto]">
                  <div className="w-full flex flex-col relative flex-[0_0_auto] items-start gap-8">
          ...
          <Card className="w-full py-[16px] px-[24px] bg-background-primary">
            <CardContent className="p-0">
              ...
              <div className="mt-[16px]">
                <div className="flex flex-col items-center gap-8">
                  <div className="w-full flex flex-col gap-2">
                    ...
                    <Input
                      ...
                      className=" h-[48px] px-4 py-2 bg-white rounded border border-solid border-[#e4e2dd] [font-family:'Lato',Helvetica] font-normal text-on-surface-secondary text-base tracking-[0] leading-6"
                    />
                  </div>
                  <div className="w-full flex flex-col gap-2">
                    <div className="flex items-center gap-2.5 relative">
                ...
                <div className="flex flex-col items-center gap-8 mt-[24px]">
                  <div className="w-full flex flex-col gap-2">
                    <div className="flex items-center gap-2.5 relative">
                      <svg
                        width="24"
