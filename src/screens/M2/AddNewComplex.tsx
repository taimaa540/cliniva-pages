    ...
    <div className="flex h-screen  w-screen">
      ...
      >
        ...
        <Header
          ...
          SubTitle="Add New Medical Complex"
          onOpenSidebar={onOpenSidebar}
        />
                  ...
                  <CollapsibleContent>
                    <div className="flex flex-col lg:flex-row gap-[25px] ">
                      <div className="flex-1">
                        ...
                        <div className="flex flex-col sm:flex-row items-start gap-8 mt-[24px]">
                      ...
                      <div className="flex-1">
                        ...
                        <div className="flex flex-col sm:flex-row gap-8 mt-[24px]">
            ...
            <Card className="w-full rounded-2xl bg-background-primary">
              <CardContent className="p-[16px]">
                ...
                >
                  ...
                  <CollapsibleContent>
                    <div className="flex flex-col sm:flex-row gap-8 items-start w-full mt-[16px]">
                      <div className="flex-1 ">
                  ...
                  <CollapsibleContent>
                    <div className="flex flex-col items-start gap-[16px]">
                      <div className="flex flex-col xl:flex-row items-start gap-8 relative w-full">
                        <div className="flex-1 flex flex-col w-full items-end gap-2 relative">
                          <div className="flex flex-col sm:flex-row gap-8 relative self-stretch w-full flex-[0_0_auto]">
                        ...
                        <div className="flex-1 flex flex-col sm:flex-row justify-center relative h-12 gap-8">
                          ...
                          <Input
                            ...
                            className="w-full px-4 py-2 rounded border border-solid border-[#e4e2dd] [font-family:'Lato',Helvetica] font-normal text-on-surface-secondary text-base tracking-[0] leading-6"
                          />
                        </div>
                      </div>
                      <div className="flex flex-col sm:flex-row gap-8 relative w-full">
                        ...
                        <div className="flex flex-wrap items-start gap-4 relative">
                          {addressFields.map((field, index) => (
                            <Input
                              ...
                              className="w-[172px] px-4 py-2 rounded border border-solid border-[#e4e2dd] font-lato font-normal text-on-surface-secondary text-base tracking-[0] leading-6"
                            />
                          ))}
                        </div>
                      </div>
                      <div className="flex flex-col sm:flex-row justify-center relative h-12 gap-8 w-full mt-[10px]">
                        ...
                        <Input
                          ...
                          className="flex-1 w-full px-4 py-2 rounded border border-solid border-[#e4e2dd] [font-family:'Lato',Helvetica] font-normal text-on-surface-secondary text-base tracking-[0] leading-6"
                        />
                      </div>
                    </div>
                  </CollapsibleContent>
