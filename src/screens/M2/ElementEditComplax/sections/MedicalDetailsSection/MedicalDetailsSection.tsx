                ...
                <div className="flex items-center justify-between p-4">
                  <div className="flex items-center gap-2.5 flex-wrap">
                    ...
                    <Select defaultValue="1">
                      <SelectTrigger className="w-auto bg-secondary-light rounded-[20px] border-0 px-2  py-1.5 sm:py-1  text-[clamp(10px,2vw,12px)]">
                        <SelectValue />
                      </SelectTrigger>
                      <SelectContent>
                      ...
                      <PaginationContent className="flex-nowrap ">
                        ...
                        <PaginationItem>
                          <Button
                            variant="outline"
                            size="sm"
                            className="w-6 h-6 sm:w-6 sm:h-6 p-1 rounded-full border-[#f1f1f1]"
                          >
                            {local === "en" ? (
