...
export const ComplexContactDetailsSectionMobile = (): JSX.Element => {
  return (
      ...
      <div className="bg-background-secondary p-[24px]  rounded-[16px] w-full h-full flex flex-col justify-between ">
        <Card className="w-full py-[16px] px-[24px] mb-[16px] bg-background-primary">
          <CardContent className="p-0">
            ...
            <div className="flex flex-col items-start gap-[16px] mt-[20px]">
              <div className="flex flex-col items-start justify-between relative self-stretch w-full flex-[0_0_auto]">
                ...
                <div className="flex flex-col justify-center relative flex-[0_0_auto] items-start gap-8">
                  ...
                  <Input
                    ...
                    className="px-4 py-2 rounded border border-solid border-[#e4e2dd] [font-family:'Lato',Helvetica] font-normal text-on-surface-secondary text-base tracking-[0] leading-6"
                  />
                </div>
              </div>
              ...
              <div className="flex flex-col items-start gap-8 relative self-stretch w-full flex-[0_0_auto]">
                ...
                <div className="items-start flex flex-col gap-[10px] relative">
              ...
              <div className="flex flex-col relative flex-[0_0_auto] items-strat gap-8">
