...
export const LegalDetailsSection = ({
  handleNext,
  prevStep,
  title,
      ...
      <div className="bg-background-secondary p-[24px] rounded-[16px] w-full">
        ...
        <Card className="w-full py-[16px] px-[24px] mb-[16px] bg-background-primary ">
          <CardContent className="flex flex-col">
            ...
            <div className="flex items-center gap-[45px] mb-[24px] w-full">
              <div className="flex-1 flex items-center gap-[32px] h-[48px] w-full">
                <label className="block w-[160px] ">VAT Number</label>
                <Input
                  type="text"
                  placeholder="Enter VAT Number"
                  className="bolck w-full h-full rounded-[4px] py-[8px] px-[16px] border border-border-light "
                />
              </div>
              <div className="flex-1 flex items-center gap-[32px] h-[48px] w-full">
        ...
        <Card className="w-full py-[16px] px-[24px] mb-[16px] bg-background-primary ">
          <CardContent className="flex flex-col">
            ...
            <div className="flex gap-8 items-start w-full mt-[16px]">
              ...
              <div className="flex-1 w-full">
                <label className="block w-[160px] mb-[8px]">Description</label>
                <div className="flex-1 flex flex-col items-end gap-2 w-full">
                  <Input
                    placeholder="Enter Description"
                    className=" bolck w-full h-[48px] rounded-[4px] py-[8px] px-[16px] border border-border-light "
                  />
                  <PlusIcon className="w-6 h-6 text-gray-600 cursor-pointer text-secondary-dark" />
                </div>
              </div>
            </div>
          </CardContent>
        ...
        {/* Privacy Policy */}
        <Card className="w-full py-[16px] pl-[24px] pr-[58px] mb-[16px] bg-background-primary ">
          <CardContent className="flex flex-col gap-4">
            ...
            <div className="flex gap-8 items-start w-full ">
              ...
              <div className="flex-1 relative flex flex-col items-end gap-2 w-full">
                <Input
                  placeholder="Enter Description"
                  className=" bolck w-full h-[48px] rounded-[4px] py-[8px] px-[16px] border border-border-light "
                />
