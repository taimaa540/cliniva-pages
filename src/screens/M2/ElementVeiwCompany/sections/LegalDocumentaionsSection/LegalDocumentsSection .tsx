...
export const ElementViewCompany = (): JSX.Element => {
  ...
  return (
    <div className="flex h-screen  w-screen">
      ...
      >
<Header MainTitle="Medical Facilities" SubTitle="View Company Details" onOpenSidebar={onOpenSidebar}  />
  ...
  "
                >
                  <Edit2Icon
                    className="w-3 h-3 sm:w-4 sm:h-4 md:w-5 md:h-5 lg:w-5 font-lato lg:h-5 text-text-inverse"
                  />
                  {t("Edit")}
                </Button>
              </Link>
                  ...
                  <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    ...
                    <div className="flex flex-col gap-6">
                      ...
                      <div className="flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-4">
                        <div className="font-semibold min-w-[160px] font-lato text-[clamp(14px,1.1vw,16px)]">
                          {t("Logo:")}
                        </div>
                      ...
                      <div className="flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-4">
                        ...
                        <div className="text-[clamp(12px,1.1vw,16px)] font-lato">{companyInfo.tradeName}</div>
                      </div>

                      {/* Year of Establishment */}
                      <div className="flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-4">
                        <div className="font-semibold   min-w-[160px] text-[clamp(14px,1.1vw,16px)] font-lato">
                          {t("Year of Establishment")}:
                        </div>
                        <div className="text-[clamp(12px,1.1vw,16px)] font-lato " >{companyInfo.yearEstablished}</div>
                      </div>
                      ...
                      <div className="flex flex-col sm:flex-row sm:items-start  gap-6 sm:gap-4">
                        ...
                        <div className="text-[clamp(12px,1.1vw,16px)] font-lato">{companyInfo.overview}</div>
                      </div>
                      ...
                      <div className="flex flex-col sm:flex-row sm:items-center  sm:gap-4  gap-6">
                        ...
                        <div className="text-[clamp(12px,1.1vw,16px)] font-lato">{companyInfo.goals}</div>
                      </div>
                    </div>
                    ...
                    <div className="flex flex-col gap-6">
                      ...
                      <div className="flex flex-col sm:flex-row sm:items-center   gap-4">
                        <div className="font-semibold font-lato min-w-[160px] text-[clamp(14px,1.1vw,16px)]">
                          {t("Legal Name")}:
                        </div>
                        <div className="text-[clamp(14px,1.1vw,16px)] font-lato" >{companyInfo.legalName}</div>
                      </div>
                      ...
                      <div className="flex flex-col sm:flex-row sm:items-center   gap-4">
                        ...
                        <div className="  text-[clamp(12px,1.1vw,16px] min-w-[160px] font-lato ">{companyInfo.vision}</div>
                      </div>
                      ...
                      <div className="flex flex-col sm:flex-row sm:items-center  gap-4 ">
                        ...
                        <div className="text-[clamp(12px,1.1vw,16px)]font-lato ">{companyInfo.ceoName}</div>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="px-4 pb-4">
                  ...
                  <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    ...
                    <div className="flex flex-col gap-8">
                      ...
                      <div className="flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-4">
                        {/* Icon + Label */}
                        <div className="flex items-center min-w-[160px] gap-2 sm:gap-3">
                          <PhoneIcon className="text-text-primary w-4 h-4 sm:w-5 sm:h-5 md:w-6 md:h-6 lg:w-7 lg:h-7" />
                          <div className="font-semibold font-lato text-[clamp(14px,1.1vw,16px)]">
                            {t("Phone Numbers")}:
                          </div>
                        </div>
                        {/* Content */}
                        <div className="text-[clamp(12px,1.1vw,16px)] font-lato break-words">
                      ...
                      {/* Physical Address */}
                      <div className="flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-4">
                        <div className="flex items-center gap-2 min-w-[160px] sm:gap-3">
                      ...
                      <div className="flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-4">
                        ...
                        <a
                          ...
                          className="text-[clamp(12px,1.1vw,16px)] text-start font-lato text-blue-600 break-all"
                        >
                    ...
                    <div className="flex flex-col gap-8">
                      ...
                      <div className="flex flex-col sm:flex-row sm:items-center ">
                        ...
                        <div className="text-[clamp(12px,1.1vw,16px)]  font-lato break-all">
                          {contactInfo.website}
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="flex flex-col gap-6">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-[auto_1fr] items-start gap-y-2 md:gap-y-0 ">
                        ...
                        <div className="flex items-center gap-1 sm:gap-2">
                          ...
                          <span className="font-semibold  min-w-[160px] font-lato text-[clamp(14px,1.1vw,16px)]">
                            {t("LinkedIn")}:
                          </span>
                        </div>
                        ...
                        <a
                          ...
                          target="_blank"
                          rel="noopener noreferrer"
                          className="text-[clamp(12px,1.1vw,16px)] font-lato text-on-surface-primary break-all"
                        >
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-[auto_1fr] items-start gap-y-2 md:gap-y-0  ">
                        <div className="flex items-center gap-1 sm:gap-2 md:gap-3">
                          ...
                          <span className="font-semibold font-lato min-w-[160px] text-[clamp(14px,1.1vw,16px)]">
                            {t("Facebook")}:
                          </span>
                        </div>
                        <div className="text-[clamp(12px,1.1vw,16px)] font-lato text-on-surface-primary break-words">
