              ...
              <div className="h-full pb-5 gap-y-5">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-y-4 gap-[clamp(8px,1.6vw,24px)]">
                  ...
                  <div className="flex flex-col sm:flex-row pb-3 sm:items-center gap-y-2 ">
                    <div className="text-text-primary font-semibold  h-10 sm:h-10 sm:w-[clamp(88px,10vw,162px)] text-[clamp(16px,1.1vw,16px)]md:h-12">
                      {t("Logo")}
                    </div>
                  ...
                  <div className="flex flex-col sm:flex-row sm:items-start gap-y-2 ">
                    ...
                    <Textarea
                      className="w-[min(100%,360px)]  h-[60px] sm:h-[72px] md:h-[82px] lg:h-[96px]  
                       border-light border bg-background-secondary text-text-primary font-sans text-[clamp(13px,1.1vw,16px)]"
                  ...
                  <div className="flex flex-col sm:flex-row sm:items-start gap-y-2 ">
                    ...
                    <Textarea
                      className="w-[min(100%,360px)]  h-[60px] sm:h-[72px] md:h-[82px] lg:h-[96px]  
                       border-light border bg-background-secondary text-text-primary font-sans text-[clamp(14px,1.1vw,16px)]"
          ...
          <ReusableCollapsible
            ...
            content={<div className="px-4 pb-4  ">      <div className="space-y-7 justi">
              ...
              <div className=" flex gap-x-[123px]  flex-wrap  " >
                ...
                <div className="  sm:w-[520px]  gap-y-2 rounded-md py-1">
                  {/* Label + Input */} <div className="flex   flex-col  sm:flex-row gap-y-2 gap-x-8"> {/* Label + Icon */} <div className="flex items-center text-center gap-2">
                    ...
                    <div className="text-text-primary  font-semibold sm:w-[clamp(120px,10vw,160px)] text-[clamp(16px,1.1vw,16px)]">
                      {t("Phone Number")}: </div>
                  </div> {/* Phone Input */}
                ...
                <div className="flex flex-col sm:flex-row sm:items-center w-full sm:w-[520px]  h-12 gap-y-2 gap-x-8">
                  ...
                  <div className="flex items-center gap-2 sm:w-[166px] h-6 flex-shrink-0">
                    ...
                    <span className="min-w-[160px] text-text-primary font-semibold text-[clamp(16px,1.1vw,16px)] leading-6">
                      {t("Email")}:
                    </span>
                  </div>
              ...
              <div className="flex flex-col md:flex-row md:items-start lg:items-start   gap-3">
                <div className="flex w-[186px] items-center gap-4 mt-2">
                  ...
                  <div className="min-w-[160px] text-text-primary font-semibold text-[clamp(16px,1.1vw,16px)]">
                    {t("Physical Address")}:
                  </div >
                </div>
                <div className="grid gap-4 w-full grid-cols-2 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 ">
                  {addressFields.map((field, index) => (
                    <Input
                      key={index}
                      className=" w-[min(100%,172px)]  h-10 sm:h-10 md:h-12 text-[clamp(14px,1.1vw,16px)] placeholder:text-[clamp(14px,1.1vw,16px)]   border-light border bg-background-secondary  text-text-primary  font-sans"
              ...
              <div className=" flex gap-x-[121px]  gap-y-11 flex-wrap ">
                ...
                <div className="flex flex-col sm:flex-row sm:items-center w-full sm:w-[520px] gap-y-2 gap-x-10">
                  ...
                  <div className="flex items-center gap-2 w-full sm:w-[160px]">
                    ...
                    <span className="text-text-primary min-w-[160px] font-semibold text-[clamp(16px,1.1vw,16px)]">
                      {t("Maps Location")}:
                    </span>
                  </div>
            ...
            content={<div className="pb-4">       <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="flex flex-col md:flex-row md:items-center gap-2 md:gap-6">
                  <label className="w-32 shrink-0 font-semibold text-text-primary">
                    {t("VAT")}:
                  </label>
                  <Input
                    className="w-[min(100%,360px)] text-[clamp(14px,1.1vw,16px)]  h-10 sm:h-10 md:h-12  border-light border bg-background-secondary text-text-primary font-sans"
              ...
              <Card className="w-full bg-background-primary rounded-[16px] ">
                            ...
                            >
                              ...
                              <div className="flex flex-col gap-4">
                                ...
                                <div className="flex flex-col md:flex-row md:items-center gap-2 md:gap-4">
                                  ...
                                  <Input
                                    className="w-[min(100%,360px)] text-[clamp(14px,1.1vw,16px)]  h-10 sm:h-10 md:h-12 border border-light bg-background-secondary text-text-primary font-sans"
                                ...
                                <div className="flex flex-col md:flex-row md:items-center gap-2 md:gap-4">
                                  ...
                                  <Input
                                    className="w-full h-12 border border-light text-[clamp(14px,1.1vw,16px)] bg-background-secondary text-text-primary font-sans"
                            ...
                            >
                              ...
                              <div className="flex flex-col md:flex-row md:items-center gap-2 md:gap-4">
                                ...
                                <div className="flex items-center gap-2 w-full">
                                  <Input
                                    className="w-full  h-10 sm:h-10 md:h-12 text-[clamp(14px,1.1vw,16px)] border border-light bg-background-secondary text-text-primary font-sans"
