...
const socialMediaData = [
  {
    ...
    , ll: "//www.linkedin.com/company/medcare-group",
...
const addressFields = [
  { label: "Building Number", value: 3 },
  { label: "Street Name", value: "Al" },
...
export const ElementEditCompany = (): JSX.Element => {
  ...
  return (
    <div className="flex h-screen  w-screen">
      ...
      >
<Header MainTitle="Medical Facilities" SubTitle="Edit Company Details" onOpenSidebar={onOpenSidebar}  />
    ...
    lg:w-[200px] lg:h-[40px]  rounded-[20px] bg-secondary-dark font-lato font-medium text-sm leading-[100%] tracking-[0] text-surface-primary">
            ...
            <ReusableCollapsible
              ...
              content={
                <div className="h-full pb-5 gap-y-5">
                  <div className="grid grid-cols-1 lg:grid-cols-2 gap-y-4 gap-[clamp(8px,1.6vw,24px)]">

                    {/* Logo */}
                    <div className="flex flex-col sm:flex-row pb-3 sm:items-center gap-y-2 ">
                      <div className="text-text-primary font-semibold  h-10 sm:h-10 sm:w-[165px] font-lato text-[clamp(16px,1.1vw,16px)] md:h-12">
                        {t("Logo")}
                      </div>
                      <div className="relative w-[clamp(40px,6vw,40px)] h-[clamp(40px,6vw,40px)] bg-[url(/user-image-12.svg)] bg-[100%_100%]">
                        <ImageUploader initialImage="/logo.png" />
                      </div>
                    </div>

                    {/* Trade Name */}
                    <div className="flex flex-col sm:flex-row   sm:items-center gap-y-2 ">
                      <div className="text-text-primary font-semibold  h-10 sm:h-10 sm:w-[165px] text-[clamp(16px,1.1vw,16px)] font-lato md:h-12">
                        {t("Trade Name")}
                      </div>
                      <Input
                        className="w-[min(100%,360px)]  h-10 sm:h-10 md:h-12 text-[clamp(14px,1.1vw,16px)]
                       flex items-center border-light border bg-background-secondary 
                    ...
                    <div className="flex flex-col sm:flex-row sm:items-start gap-y-2 ">
                      ...
                      <Textarea
                        className="w-[min(100%,360px)]  h-[60px] sm:h-[72px] md:h-[82px] lg:h-[96px]  
                       border-light border bg-background-secondary text-text-primary font-lato text-[clamp(13px,1.1vw,16px)]"
                    ...
                    <div className="flex flex-col sm:flex-row sm:items-start gap-y-2 ">
                      ...
                      <Textarea
                        className="w-[min(100%,360px)]  h-[60px] sm:h-[72px] md:h-[82px] lg:h-[96px]  
                       border-light border bg-background-secondary text-text-primary font-lato text-[clamp(14px,1.1vw,16px)]"
                    ...
                    <div className="flex flex-col sm:flex-row sm:items-center gap-y-2 ">
                      ...
                      <Input
                        className="w-[min(100%,360px)] font-lato  h-10 sm:h-10 md:h-12 text-[clamp(14px,1.1vw,16px)]
                       flex items-center border-light border bg-background-secondary 
                       text-text-primary "
              ...
              content={<div className="px-4 pb-4  ">      <div className="space-y-7 justi">
                ...
                <div className=" flex gap-x-[53px]  flex-wrap  " >
                  ...
                  <div className="  w-full sm:w-[520px] gap-y-2 rounded-md py-1">
                    {/* Label + Input */} <div className="flex  items-start  flex-col  sm:flex-row  "> {/* Label + Icon */} <div className="flex items-center text-center mt-3  pb-9 gap-x-2">
                      ...
                      <div className="text-text-primary text-start font-lato  font-semibold min-w-[160px] text-[clamp(16px,1.1vw,16px)]">
                        {t("Phone Number")}: </div>
                    </div> {/* Phone Input */}
                      <div className="relative  w-[min(100%,360px)]  ">
                        ...
                        <PhoneInputCustom value={contactData.phoneNumber}
                  ...
                  <div className="flex flex-col sm:flex-row sm:items-center w-full sm:w-[520px]  h-12 gap-y-2 gap-x-8">
                    ...
                    <div className="flex items-center gap-2 sm:w-[166px] h-6 flex-shrink-0">
                      ...
                      <span className=" font-lato text-text-primary font-semibold  text-[clamp(14px,1.1vw,16px)] leading-6">
                        {t("Email")}:
                      </span>
                    </div>
                ...
                <div className="flex flex-col md:flex-row md:items-start lg:items-start   gap-3">
                  <div className="flex w-[186px] items-center gap-4 mt-2">
                    ...
                    <div className="min-w-[160px] text-text-primary font-semibold font-lato text-[clamp(16px,1.1vw,16px)]">
                      {t("Physical Address")}:
                    </div >
                  </div>
                  <div className="grid gap-4 w-full grid-cols-2 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 ">
                    {addressFields.map((field, index) => (
                      <Input
                        key={index}
                        className=" w-[min(100%,172px)] font-lato  h-10 sm:h-10 md:h-12 text-[clamp(14px,1.1vw,16px)] placeholder:text-[clamp(14px,1.1vw,16px)]   border-light border bg-background-secondary  text-text-primary  font-lato"
                ...
                <div className=" flex gap-x-[51px]  gap-y-11 flex-wrap ">
                  ...
                  <div className="flex flex-col sm:flex-row sm:items-center w-full sm:w-[520px]  h-12 gap-y-2 gap-x-8">
                    ...
                    <div className="flex items-center gap-2 sm:w-[166px] h-6 flex-shrink-0">
                      ...
                      <span className="min-w-[160px] text-text-primary font-semibold font-lato text-[clamp(16px,1.1vw,16px)] leading-6">
                        {t("Company Website")}:
                      </span>
                    </div>
                 ...
                 text-text-primary font-lato"
                  ...
                  <div className="flex flex-col sm:flex-row sm:items-center w-full sm:w-[520px] gap-y-2 gap-x-10">
                    ...
                    <div className="flex items-center gap-2 w-full sm:w-[160px]">
                      ...
                      <span className="text-text-primary min-w-[160px] font-lato font-semibold text-[clamp(16px,1.1vw,16px)]">
                        {t("Maps Location")}:
                      </span>
                    </div>
                    ...
                    {/* Input */}
                    <Input
                      className="w-[min(100%,360px)] font-lato md:w-[360px]  h-10 sm:h-10 md:h-12 
               border border-light rounded-md bg-background-secondary text-[clamp(14px,1.1vw,16px)]
               text-text-primary font-lato"
                      defaultValue={contactData.mapsLocation}
                    />
                  </div>
            ...
            <ReusableCollapsible
              ...
              content={
                <div className="px-4 pb-4 h-full">
                  <div className="grid grid-cols-1 pb-4  h-full md:grid-cols-2 gap-6 gap-y-11">
                    {socialMediaData.map((social, index) => (
                      ...
                      >
                        {/* Icon + Label */}
                        <div className="flex items-center gap-2 font-lato  w-[min(100%,166px)] h-6">
                          <div className="w-5 h-5 sm:w-6 sm:h-6 md:w-7 md:h-7">
                            {social.url} {/* أيقونة بدل social.url */}
                          </div>
                          <span className="text-text-primary font-semibold font-lato text-[clamp(16px,1.1vw,16px)] leading-6">
                            {social.platform}:
                          </span>
                        </div>
            ...
            <ReusableCollapsible
              ...
              content={<div className="pb-4 ">       <div className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div className="flex flex-col md:flex-row md:items-center gap-2 md:gap-6">
                    <label className="w-32 shrink-0 font-lato font-semibold text-text-primary">
                      {t("VAT")}:
                    </label>
                    <Input
                      className="w-[min(100%,360px)] text-[clamp(14px,1.1vw,16px)]  h-10 sm:h-10 md:h-12  border-light border bg-background-secondary text-text-primary font-lato"
                  ...
                  {/* CR */}
                  <div className="flex flex-col md:flex-row md:items-center gap-2 md:gap-6">
                    <label className="w-32 font-lato shrink-0 font-semibold text-text-primary">
                      {t("CR")}:
                    </label>
                    <Input
                      className="w-[min(100%,360px)] text-[clamp(14px,1.1vw,16px)]   h-10 sm:h-10 md:h-12  border-light border bg-background-secondary text-text-primary font-lato"
                ...
                <Card className="w-full bg-surface-default rounded-[16px] ">
                  <CardContent dir={local === "en" ? "ltr" : "rtl"}>
                    ...
                    >
                      <CollapsibleTrigger asChild>
                        <Button
                          variant="ghost"
                          className="p-0 hover:bg-[none] w-full bg-surface-default"
                        >
                        ...
                        <div>
                          <div className="pb-4 space-y-6">
                            ...
                            <div className="flex flex-col">
                              {legalData.termsConditions.map((term, index) => (<div className="flex items-end">
                                <div
                                  key={index}
                                  className="flex flex-col gap-4 border rounded-lg p-4 w-full shadow-sm bg-surface-default"
                                >
                                  {/* ديف خاص بالعنوان والوصف */}
                                  <div className="flex flex-col gap-4">
                                    {/* Title Field */}
                                    <div className="flex flex-col md:flex-row md:items-center gap-2 md:gap-4">
                                      <label className="w-32 shrink-0 font-lato font-semibold text-[clamp(16px,1.1vw,16px)] text-text-primary">
                                        {t("Title")}:
                                      </label>
                                      <Input
                                        className="w-[min(100%,360px)] text-[clamp(14px,1.1vw,16px)]  h-10 sm:h-10 md:h-12 border border-light bg-background-secondary text-text-primary font-lato"
                                    ...
                                    <div className="flex flex-col md:flex-row md:items-center gap-2 md:gap-4">
                                      ...
                                      <Input
                                        className="w-full h-12 border border-light text-[clamp(14px,1.1vw,16px)] bg-background-secondary text-text-primary font-lato"
                                        defaultValue={term.description}
                                      />
                                    </div>
                                  </div>

                                  {/* الناقص مستقل بأسفل الكارد */}

                                </div>
                                <div className="flex justify-end">
                                  <div className="cursor-pointer pb-4 ps-2">
                                    <svg
                                      width="24"
                                      height="2"
                                      viewBox="0 0 24 2"
                            ...
                            {/* زر الزائد وحيد بأسفل القائمة */}

                          </div>
                          <div className="flex justify-end text-secondary-dark">
                  ...
                  <CardContent dir={local === "en" ? "ltr" : "rtl"}>
                    ...
                    >
                      ...
                      <CollapsibleContent className="w-full">
                        ...
                        <div className=" pb-4 m-0 p-0 px-0 space-y-6">
                                ...
                                >
                                  ...
                                  <div className="flex flex-col md:flex-row md:items-center gap-2 md:gap-4">
                                    ...
                                    <div className="flex items-center gap-2 w-full">
                                      <Input
                                        className="w-full  h-10 sm:h-10 md:h-12 text-[clamp(14px,1.1vw,16px)] border border-light bg-background-secondary text-text-primary font-lato"
                          ...
                          {/* زر الإضافة */}
                          <div className="flex justify-end p-0  ps-10">
            ...
            <ReusableCollapsible
              ...
              initiallyOpen={isOpen.mapsLocation}
              onOpenChange={(open) => handleToggle("mapsLocation", open)}
              content={<div>      <div className="w-full h-[332px] pb-3 bg-[url(/background.png)] bg-cover bg-center rounded" />
                <p className="font-title-14px-regular pb-3 font-[number:var(--title-14px-regular-font-weight)] text-on-surface-primary text-[length:var(--title-14px-regular-font-size)] tracking-[var(--title-14px-regular-letter-spacing)] leading-[var(--title-14px-regular-line-height)] [font-style:var(--title-14px-regular-font-style)]">
