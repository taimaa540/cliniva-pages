  ...
  return (
    ...
    >
      ...
      <header className="flex h-[50px] justify-between pl-[4px] pr-0 py-0 bg-background-primary self-stretch w-full items-center">
          ...
          >
            <div className="flex items-center gap-4 rounded-2xl ">
              ...
              <div className="flex flex-col">
                <h1 className=" text-text-primary font-semibold  text-[22px]">
       ...
       <Card className="flex flex-col h-auto   p-5  bg-background-tertiary relative self-stretch w-full rounded-2xl overflow-hidden">
       <div className="flex gap-[16px] justify-end  items-end text-end   "  dir={local === 'ar' ? 'rtl' : 'ltr'} >
        ...
        <CardContent className="p-0 w-full overflow-y-auto scroll-x-hidden pb-9 gap-5 h-full">
          ...
          <ReusableCollapsible
            ...
            content={<div className="">      <div className="grid grid-cols-2 gap-6">
              ...
              <div className="flex items-center gap-2">
                <div className="   text-text-primary font-semibold w-[182px] ">
                  {t("Trade Nam")}
                </div>
                <Input
              ...
              <div className="flex items-center ">
                ...
                <DatePicker label={t("Year of Establishment")} />
              </div>
              ...
              <div className=" flex gap-x-[121px] gap-y-5 flex-wrap " >
                ...
                <div className="flex gap-[70px] ">
                  <div className="flex w-[100px] items-center justify-center mb-16 gap-1">
                    ...
                    <div className="text-text-primary w-80 justify-center font-semibold">
                      {t("Email")}:
                    </div>
                  </div>
                  <Input
