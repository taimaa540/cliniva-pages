    ...
    >
      ...
      <Card className="flex flex-col h-auto items-start gap-6 p-5 mt-[10px] bg-background-tertiary relative self-stretch w-full rounded-2xl overflow-hidden">
        ...
        <CardContent className="p-0 w-full overflow-y-auto gap-5 h-auto">
          ...
          <div className="flex justify-end items-end w-full"dir={local === 'ar' ? 'rtl' : 'ltr'}>

            <Button className="w-[200px] text-text-inverse rounded-[20px] font-btn-14px-medium bg-secondary-dark">
              <svg width="15" height="16" viewBox="0 0 15 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M10.833 1.99955C11.0081 1.82445 11.216 1.68556 11.4447 1.5908C11.6735 1.49604 11.9187 1.44727 12.1663 1.44727C12.414 1.44727 12.6592 1.49604 12.8879 1.5908C13.1167 1.68556 13.3246 1.82445 13.4997 1.99955C13.6748 2.17465 13.8137 2.38252 13.9084 2.61129C14.0032 2.84006 14.052 3.08526 14.052 3.33288C14.052 3.58051 14.0032 3.8257 13.9084 4.05448C13.8137 4.28325 13.6748 4.49112 13.4997 4.66622L4.49967 13.6662L0.833008 14.6662L1.83301 10.9995L10.833 1.99955Z" stroke="#FFFDFC" stroke-linecap="round" stroke-linejoin="round" />
              </svg>
              Edit
            </Button>
          </div>
            ...
            <div className="px-4 pb-4">
              <div className="flex flex-col md:flex-row gap-4 md:gap-[38px]">
                {capacityData(t).map((item, index) => (
                  <Card key={index} className={`flex-1 h-[100px] ${item.bgColor} rounded-[25px] w-[350px] shadow-[0px_2px_8px_#e2f6ec]`}>
          ...
          <ReusableCollapsible
            ...
            {t("Description")}
              ...
              <div className="flex gap-2">
                <div className="flex items-center gap-2.5 w-[162px]">
          ...
          <ReusableCollapsible
            ...
            dir={local === 'ar' ? 'rtl' : 'ltr'}
            onOpenChange={(open) => handleToggle("mapsLocation", open)}
            content={<div className="px-4 pb-4">         {/* الصف الأول: الهاتف والبريد الإلكتروني */}
              <div className="grid grid-cols-2 gap-8 mb-6">
                <div className="flex items-start gap-3">
                  <PhoneIcon className="w-6 h-6" /> {/* 24x24px */}
              ...
              {/* الصف الثاني: العنوان والموقع على الخريطة */}
              <div className="  grid grid-cols-2 gap-8 mb-6">
                <div className="flex items-start gap-3">
                  <div className="text-text-primary">
          ...
          <ReusableCollapsible
            ...
            content={<div className="p-0">     <div className="bg-surface-default rounded-2xl overflow-hidden">
              <Table>
                <TableHeader className="">
                  <TableRow>
                    <TableHead className="w-[10%]   text-text-praimary  font-semibold  text-start">
                        {t("No")}
                    </TableHead>
                    <TableHead className="w-[40%]   text-text-praimary  font-semibold  text-center">
                         {t("Department Name")}
                    </TableHead>
                    <TableHead className="w-[50%]   text-text-praimary  font-semibold  text-center">
                        {t("Description")}
                    </TableHead>
                  </TableRow>
                </TableHeader>
                <TableBody>
                  {departments.map((dept, index) => (
                    <TableRow key={index} className="border-b h-[78px] border-[#e4e2dd] justify-between">
                      <TableCell className=" text-start font-title-14px-semibold   ">
                        <div className=" flex ">
                          {dept.number}
                        </div>
                      </TableCell>
                      ...
                      <TableCell className="w-[330px] text-text-primary font-regular text-[14px] leading-[1.25] tracking-[0] font-[Lato]">
                        {dept.description}
                      </TableCell>
                    </TableRow>
                  ))}
          ...
          <ReusableCollapsible
            ...
            content={<div className="px-4 pb-4"><div className="bg-surface-default rounded-2xl overflow-hidden">
              <Table>
                <TableHeader className="">
                  <TableRow>
                    <TableHead className="items-center text-text-primary">
                   {t("Working Days")}
                    </TableHead>
