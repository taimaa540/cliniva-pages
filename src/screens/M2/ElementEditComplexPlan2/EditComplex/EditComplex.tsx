  ...
  return (
        ...
        <header className="flex h-[50px] justify-between pl-[4px] pr-0 py-0 self-stretch w-full items-center bg-background-primary">
          ...
          <div className="flex items-center gap-4">
            <div className="flex flex-col">
              <h1 className="font-bold text-[clamp(12px,2vw,14px)] md:text-lg lg:text-xl text-on-surface-primary">
                {t("Medical Complex Details")}
              </h1>
              <p className="text-xs sm:text-sm md:text-base text-on-surface-primary">
                {t("Edit Medical Facilitiess")}
              </p>
            </div>
          </div>
    ...
    lg:w-[200px] lg:h-[40px]  rounded-[20px] bg-secondary-dark font-lato font-medium text-sm leading-[100%] tracking-[0] text-surface-primary">
            ...
            <ReusableCollapsible
              ...
              content={
                <div className="grid grid-cols-1 pb-4 md:grid-cols-2 gap-6">
                  {/* العمود الأول */}
                  <div className="flex flex-col gap-6">


                    <div className="flex flex-col lg:flex-row sm:items-center ">
                      <label className="min-w-[160px] md:w-36 lg:w-40 font-semibold text-[clamp(14px,2vw,16px)] text-text-primary [font-family:'Lato',Helvetica]">
                        {t("Clinic Name")}:
                      </label>
                      <Input
                   ...
                   text-text-primary font-sans border-border-light text-[clamp(12px,2vw,14px)]"
                      />
                    </div>
                    ...
                    <div className="flex flex-col sm:flex-row sm:items-start ">
                      <label className="min-w-[160px] md:w-36 lg:w-40 font-semibold text-[clamp(14px,2vw,16px)] text-text-primary">
                        {t("Description")}:
                      </label>
                      <Textarea
                  ...
                  <div className="flex flex-col gap-6">
                    ...
                    <div className="flex flex-col sm:flex-row sm:items-center ">
                      <label className="min-w-[160px] md:w-36 lg:w-40 font-semibold text-[clamp(12px,1.1vw,14px)] text-text-primary [font-family:'Lato',Helvetica]">
                        {t("Staff Capacity")}:
                      </label>
                      <Input
                        ...
                        className="w-[min(100%,360px)] h-10 sm:h-10 md:h-12
                   border-light border bg-background-secondary
                   text-text-primary font-sans border-border-light text-[clamp(12px,1.1vw,14px)]"
                      />
                    </div>
                ...
                <div className=" flex gap-x-[123px]  flex-wrap  " >
                  ...
                  <div className="flex flex-col sm:flex-row lg:items-start sm:items-center gap-y-2 gap-x-4  w-full sm:w-[520px]">
                    ...
                    <div className="flex items-center mt-2 gap-2 min-w-[180px] sm:justify-start">
                      ...
                      <span className="text-text-primary  font-semibold text-[clamp(14px,2vw,16px)]">
                        {t("Email")}:
                      </span>
                    </div>
      ...
      text-text-primary font-sans"
                ...
                <div className="flex flex-col md:flex-row md:items-start lg:items-start   gap-3">
                  <div className="flex w-[186px] items-center gap-4 mt-2">
                    ...
                    <div className="min-w-[160px] text-text-primary font-semibold text-[clamp(14px,2vw,16px)]">
                      {t("Physical Address")}:
                    </div >
                  </div>
                  <div className="grid gap-4 w-full grid-cols-2 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 ">
                    {contactInfo(t).physicalAddress.map((field, index) => (
                      <Input
                        key={index}
                        className=" w-[min(100%,172px)] h-10 sm:h-10 md:h-12  border-light border bg-background-secondary  text-text-primary  font-sans"
                ...
                <div className=" flex gap-x-[121px]  gap-y-11 flex-wrap ">
                  ...
                  <div className="flex flex-col sm:flex-row sm:items-center w-full sm:w-[520px]  h-12 gap-y-2 gap-x-8">
                    ...
                    <div className="flex items-center gap-2 sm:w-[166px] h-6 flex-shrink-0">
                      ...
                      <span className="min-w-[160px] text-text-primary font-semibold text-[clamp(14px,2vw,16px)] leading-6">
                        {t("Company Website")}:
                      </span>
                    </div>
                 ...
                 text-text-primary font-sans"
                  ...
                  <div className="flex flex-col sm:flex-row sm:items-center w-full sm:w-[520px] gap-y-2 gap-x-10">
                    ...
                    <div className="flex items-center gap-2 w-full sm:w-[160px]">
                      ...
                      <span className="text-text-primary min-w-[160px] font-semibold text-[clamp(14px,2vw,16px)]">
                        {t("Maps Location")}:
                      </span>
                    </div>
              ...
              content={<div className="p-0">
                <div className="w-full overflow-x-auto">
                  <Table className="min-w-[700px]"> {/* بتحدد أقل عرض مشان السكرول يشتغل */}
                    <TableHeader>
                      <TableRow>
                        <TableHead className="w-[58px] text-center font-semibold text-[clamp(14px,1.1vw,16px)] text-text-primary">
                          {t("NO")}
                        </TableHead>
                        <TableHead className="text-center font-semibold text-[clamp(14px,1.1vw,16px)] text-text-primary">
                          {t("Name")}
                        </TableHead>
                        <TableHead className="text-center font-semibold text-[clamp(14px,1.1vw,16px)] text-text-primary">
                          {t("PIC")}
                        </TableHead>
                        <TableHead className="w-[255px] text-center font-semibold text-[clamp(14px,1.1vw,16px)] text-text-primary">
                    ...
                    <TableBody>
                      {linkedClinics.map((clinic) => (
                        <TableRow key={clinic.number} className="border-b border-[#e4e2dd]">
                          <TableCell className="text-center font-medium text-[clamp(12px,1.1vw,14px)] text-text-primary">
                            {clinic.number}
                          </TableCell>
                          <TableCell className="text-center font-medium text-[clamp(12px,1.1vw,14px)] text-text-primary">
                            {clinic.name}
                          ...
                          <TableCell className="text-center">
                            <div className="flex items-center justify-center gap-2">
                              <Badge className="bg-secondary-light text-secondary-dark rounded-[20px] w-[92px] h-[24px] justify-center text-[clamp(12px,2vw,14px)]">
                                Active
                              </Badge>
                            </div>
                          </TableCell>
                ...
                <div className="p-0">
                  <div className="overflow-x-auto w-full">
                    <Table className="min-w-[600px] border-collapse w-full">
                      <TableHeader>
                        <TableRow>
                          <TableHead className="w-[10%] text-text-praimary  text-[clamp(14px,1.1vw,16px)] font-semibold text-center px-1 sm:px-2 md:px-4">
                            {t("No")}
                          </TableHead>
                          <TableHead className="w-[30%] text-center text-text-praimary text-[clamp(14px,1.1vw,16px)] font-semibold px-1 sm:px-2 md:px-4">
                            {t("Department Name")}
                          </TableHead>
                          <TableHead className="w-[60%] text-center text-text-praimary text-[clamp(14px,1.1vw,16px)] font-semibold px-1 sm:px-2 md:px-4">
                            {t("Description")}
                          </TableHead>
                        </TableRow>
                      </TableHeader>
                      ...
                      <TableBody>
                        {departments.map((department, index) => (
                          ...
                          >
                            {/* Number */}
                            <TableCell className="text-center text-text-primary font-semibold title-14px px-1 sm:px-2 md:px-4">
                              {department.number}
                            </TableCell>

                            {/* Department Name */}
                            <TableCell className="text-text-primary font-semibold title-14px px-1 sm:px-2 md:px-4">
                        ...
                        {doctorsAndStaff.map((person) => (
                          ...
                          >
                            ...
                            <TableCell className="w-[15%] text-center">
                              <Badge className="bg-secondary-light text-secondary-dark rounded-[20px] sm:w-[92px] h-[20px] sm:h-[24px] flex items-center justify-center mx-auto text-[10px] sm:text-xs">
                                {t("Active")}
                              </Badge>
                            </TableCell>
                          </TableRow>
                        ...
                        <div className="flex items-center gap-2 sm:gap-4 w-full sm:w-[160px]">
                          ...
                          <label
                            className={`${dark ? "text-white" : "text-[#2a2b2a]"
                              } tracking-[0.07px] font-normal text-xs sm:text-sm md:text-base leading-5 sm:leading-6 whitespace-nowrap`}
                          >
                            {t(`${workDay.day}`)}
                          </label>
                        </div>
