...
export const ElementEditComplexPlan2 = (): JSX.Element => {
  ...
  return (
    <div className="flex h-screen  w-screen">
      ...
      >
<Header MainTitle="Medical Complex Detail" SubTitle="Edit Medical Facilities" onOpenSidebar={onOpenSidebar}  />
                ...
                <div className="grid grid-cols-1 pb-4 md:grid-cols-2 gap-6">
                  ...
                  <div className="flex flex-col gap-6">
                    ...
                    <div className="flex flex-col lg:flex-row sm:items-center ">
                      <label className="min-w-[160px] md:w-36 lg:w-40 font-lato font-semibold text-[clamp(14px,2vw,16px)] text-text-primary [font-family:'Lato',Helvetica]">
                        {t("Clinic Name")}:
                      </label>
                      <Input
                   ...
                   text-text-primary font-lato border-border-light text-[clamp(12px,2vw,14px)]"
                      />
                    </div>
                    ...
                    <div className="flex flex-col sm:flex-row sm:items-start ">
                      <label className="min-w-[160px] md:w-36 lg:w-40 font-lato font-semibold text-[clamp(14px,2vw,16px)] text-text-primary">
                        {t("Description")}:
                      </label>
                      <Textarea
              ...
              content={<div className="p-0">
                <div className="w-full overflow-x-auto">
                  <Table className="min-w-[700px]"> {/* بتحدد أقل عرض مشان السكرول يشتغل */}
                    <TableHeader>
                      <TableRow>
                        <TableHead className="w-[58px] font-lato text-center font-semibold  text-[clamp(14px,1.1vw,16px)] text-text-primary">
                          {t("NO")}
                        </TableHead>
                        <TableHead className="text-center font-lato font-semibold text-[clamp(14px,1.1vw,16px)] text-text-primary">
                          {t("Name")}
                        </TableHead>
                        <TableHead className="text-center font-lato font-semibold  text-[clamp(14px,1.1vw,16px)] text-text-primary">
                          {t("PIC")}
                        </TableHead>
                        <TableHead className="w-[255px]  font-lato text-center font-semibold text-[clamp(14px,1.1vw,16px)] text-text-primary">
                    ...
                    <TableBody>
                      {linkedClinics.map((clinic) => (
                        <TableRow key={clinic.number} className="border-b border-[#e4e2dd]">
                          <TableCell className="text-center font-lato font-medium text-[clamp(12px,1.1vw,14px)] text-text-primary">
                            {clinic.number}
                          </TableCell>
                          <TableCell className="text-center font-lato font-medium text-[clamp(12px,1.1vw,14px)] text-text-primary">
                            {clinic.name}
                ...
                <div className="p-0">
                  <div className="overflow-x-auto w-full">
                    <Table className="min-w-[600px] border-collapse w-full">
                      <TableHeader>
                        <TableRow>
                          <TableHead className="w-[10%] text-text-praimary font-lato  text-[clamp(14px,1.1vw,16px)] font-semibold text-center px-1 sm:px-2 md:px-4">
                            {t("No")}
                          </TableHead>
                          <TableHead className="w-[30%] text-center font-lato text-text-praimary text-[clamp(14px,1.1vw,16px)] font-semibold px-1 sm:px-2 md:px-4">
                            {t("Department Name")}
                          </TableHead>
                          <TableHead className="w-[60%] text-center font-lato text-text-praimary text-[clamp(14px,1.1vw,16px)] font-semibold px-1 sm:px-2 md:px-4">
                            {t("Description")}
                          </TableHead>
                        </TableRow>
                      </TableHeader>
                      ...
                      <TableBody>
                        {departments.map((department, index) => (
                          ...
                          >
                            {/* Number */}
                            <TableCell className="text-center text-text-primary  font-lato font-semibold title-14px px-1 sm:px-2 md:px-4">
                              {department.number}
                            </TableCell>

                            {/* Department Name */}
                            <TableCell className="text-text-primary font-semibold font-lato title-14px px-1 sm:px-2 md:px-4">
                              <div className="flex justify-center">
                                <Input
                                  defaultValue={department.name}
                                  className="w-[160px] sm:w-[200px] md:w-[240px] font-lato h-[32px] rounded-none text-text-primary border-border-light"
                                />
                              </div>
                            </TableCell>
                              ...
                              <div className="flex justify-center">
                                <div className="flex items-center gap-1 sm:gap-2">
                                  <Textarea
                                    ...
                                    className="w-[240px] sm:w-[360px] md:w-[480px] font-lato lg:w-[514px] h-[54px] text-text-primary border-[#e4e2dd] resize-none"
                                  />
                                  {index > 0 ? (
                    ...
                    {workingDays.map((workDay, index) => (
                      ...
                      >
                        ...
                        <div className="flex items-center gap-2 sm:gap-4 w-full sm:w-[160px]">
                          ...
                          />
                          <label
                            className={` tracking-[0.07px] font-normal text-xs sm:text-sm md:text-base leading-5 sm:leading-6 whitespace-nowrap`}
                          >
                            {t(`${workDay.day}`)}
                          </label>
                        </div>
