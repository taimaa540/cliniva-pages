...
export const ChoosePlan = (): JSX.Element => {
  ...
  return (
    <>
      <div className=" w-full h-screen bg-surface-default overflow-scroll p-[15px]">
        <img
          className="absolute top-[19px] left-[10px] md:left-[80px] "
          alt="Union"
          src="/Group.svg"
        />
        <img
          className="absolute top-[40px] right-[10px] md:right-[105px] "
          alt="Union"
          src="/Group2.svg"
        />
        <img
        ...
        />
        <img
          className="absolute bottom-[19px] right-[10px] md:right-[80px]"
          alt="Union"
          src="/Group4.svg"
        />
        <div>
          <button className="group hover:bg-accent relative left-[-100%] md:left-[220px] top-[30px] p-2.5 rounded-[16px]">
        ...
        <div className="flex flex-col h-[537px] items-center gap-10 mt-[100px] ml-auto mr-auto">
          ...
          <main className="flex flex-col flex-wrap md:flex-row items-center justify-center gap-12 relative flex-[0_0_auto]">
              ...
              <CardContent className="p-0 flex flex-col items-center justify-center gap-8 w-full h-full">
                <div className="inline-flex flex-col items-center justify-center gap-5 relative flex-[0_0_auto] mt-[-2.50px]">
                  ...
                  <p className="w-[252px] font-lato font-semibold text-on-surface-secondary text-[14px] text-center tracking-[0] leading-[125%]">
                    Manage a network of multiple medical complexes, each with
                    its own departments and clinics
                  </p>
                </div>
                ...
                <Link to="/CompanyPlane">
                  <Button
                    ...
                    className="group flex w-[248px]  h-12 items-center justify-center gap-2 p-[10.5px] relative mb-[-2.50px] bg-secondary-dark rounded-[19px] overflow-hidden h-auto"
                  >
            ...
            <Card className="inline-flex hover:shadow-lg hover:-translate-y-2 transition-all duration-300 ease-in-out flex-col h-[400px] items-center justify-center gap-8 px-[5px] md:px-[24px] py-[20px] md:py-[30px] relative flex-[0_0_auto] rounded-[20px] overflow-hidden border border-solid border-[#00b48d]">
              <CardContent className="p-0 flex flex-col items-center justify-center gap-8 w-full h-full">
                <div className="inline-flex flex-col items-center justify-center gap-5 relative flex-[0_0_auto] mt-[-2.50px]">
                  ...
                  <p className="w-[252px] font-lato font-semibold text-on-surface-secondary text-[14px] text-center tracking-[0] leading-[125%]">
                    Manage a single complex that contains various departments
                    and clinics under one roof
                  </p>
                </div>
                <hr className="w-[284px] text-on-surface-secondary" />
                <div className="flex flex-col items-start gap-5 relative flex-[0_0_auto]">
                ...
                <Link to="/ComplexPlane">
                  <Button
                    onClick={() => setSelectedPlan("Complex")}
                    className="group flex w-[248px]  h-12 items-center justify-center gap-2 p-[10.5px] relative mb-[-2.50px] bg-secondary-dark rounded-[19px] overflow-hidden h-auto"
                  >
                    <span className="relative w-fit font-title-16px-bold font-[number:var(--title-16px-bold-font-weight)] text-bg-subtle text-[length:var(--title-16px-bold-font-size)] text-center tracking-[var(--title-16px-bold-letter-spacing)] leading-[var(--title-16px-bold-line-height)] whitespace-nowrap [font-style:var(--title-16px-bold-font-style)]">
                      Choose this plan
            ...
            <Card className="inline-flex hover:shadow-lg hover:-translate-y-2 transition-all duration-300 ease-in-out flex-col h-[400px] items-center justify-center gap-8 px-[5px] md:px-[24px] py-[20px] md:py-[30px] relative flex-[0_0_auto] rounded-[20px] overflow-hidden border border-solid border-[#00b48d]">
              <CardContent className="p-0 flex flex-col items-center justify-center gap-8 w-full h-full">
                <div className="inline-flex flex-col items-center justify-center gap-5 relative flex-[0_0_auto] mt-[-2.50px]">
                  ...
                  <p className="w-[252px] font-lato font-semibold text-on-surface-secondary text-[14px] text-center tracking-[0] leading-[125%]">
                    A simplified setup for managing one independent clinic with
                    no additional branches or departments
                  </p>
                </div>
                <hr className="w-[284px] text-on-surface-secondary" />
                <div className="flex flex-col items-start gap-5 relative flex-[0_0_auto]">
