  ...
  return (
    <>
        ...
        <div className="flex flex-col w-[1134px] h-[537px] items-center gap-10 mt-[100px] ml-auto mr-auto">
          ...
          <main className="inline-flex items-center justify-center gap-12 relative flex-[0_0_auto]">
            {planData.map((plan, index) => (
              <Card
                key={index}
                className="inline-flex hover:shadow-lg hover:-translate-y-2 transition-all duration-300 ease-in-out flex-col h-[400px] items-center justify-center gap-8 px-[24px] py-[30px] relative flex-[0_0_auto] rounded-[20px] overflow-hidden border border-solid border-[#00b48d]"
              >
      ...
      <Routes>
        ...
        />
        <Route path="/planeCompany" element={<CompanyPlan/>} />
      </Routes>
    </>
  );
};
