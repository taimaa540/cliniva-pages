...
export const SideBarPlan1 = (): JSX.Element => {
  ...
  return (
    <>
      {showLeftSidebar && (
        <nav className="h-screen w-[223px] flex flex-col bg-background-primary">
          {/* Header */}
          <header className="flex items-center gap-[7px] mt-[25px] ml-[28px]">
            <svg
              width="30"
              height="30"
              viewBox="0 0 30 30"
      ...
      {!showLeftSidebar && (
        <nav className="h-screen w-[90px] flex flex-col bg-background-primary">
          {/* Header */}
