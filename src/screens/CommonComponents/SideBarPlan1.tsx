...
import { UserListSection } from "../M1/userListSection";
...
import { PatientDetails } from "../M5/PatientDetails";
import { Appointments } from "../M6/AppointmentsHome";
import { MoreDetails } from "../M6/MoreDetails";
...
export const SideBarPlan1 = (): JSX.Element => {
  ...
  const [dropDown1IsActive, setDropDown1IsActive] = useState<
    "Company Details" | "Complexes List" | "Clinics List"
  >("Company Details");
  ...
  return (
    <>
      {showLeftSidebar && (
        <nav className="h-screen w-[223px] max-[991px]:hidden flex flex-col bg-background-primary">
          {/* Header */}
          <header className="flex items-center gap-[7px] mt-[25px] ml-[28px] max-[767px]:mx-auto">
            <svg
              width="30"
              height="30"
              viewBox="0 0 30 30"
            ...
            <h1 className="max-[767px]:hidden font-lato font-regular text-xl leading-[110%] text-text-primary tracking-[0] ">
              Cliniva SYS
            </h1>
          </header>

          {/* Main Navigation */}
          <main className="flex flex-col flex-1 items-center mt-[27px] p-[9px] w-[223px] max-[991px]:w-[201px] max-[767px]:w-[50px]">
            <section className="w-full space-y-2">
              ...
              <Link to="/">
                ...
                >
                  ...
                  <span
                    className={`max-[767px]:hidden font-lato font-semibold text-xs leading-[130%] tracking-[0] ${
                      active === "Users Management"
              ...
              <Collapsible open={active === "Medical Facilities"}>
                <CollapsibleTrigger className="w-full">
                  ...
                  >
                    ...
                    <ChevronDownIcon
                      ...
                      className={`max-[767px]:hidden transition-transform duration-200 ${
                        active === "Medical Facilities"
                          ? "rotate-180"
                          : "rotate-0"
                      }`}
                ...
                <CollapsibleContent>
                  <div className="w-full h-[124px] bg-background-secondary">
                    <button
                      onClick={() => setDropDown1IsActive("Company Details")}
                      className={`font-lato font-regular text-xs ${
                        dropDown1IsActive === "Company Details"
                    ...
                    <button
                      onClick={() => setDropDown1IsActive("Complexes List")}
                      className={`font-lato font-regular text-xs ${
                        dropDown1IsActive === "Complexes List"
                          ? "text-secondary-default"
                          : "text-text-secondary"
                      } leading-[130%] tracking-[0] px-[28px] py-[12px] h-[40px]`}
                    >
            ...
            <Button
              variant="ghost"
              className="mt-auto mb-4 h-11 gap-3 pl-4 pr-2 py-3 bg-bg rounded-[14px] justify-start"
            >
              <LogOutIcon className="w-5 h-5" />
              <span className="max-[767px]:hidden font-btn-14px-medium text-on-surface-secondary">
                {t("Logout")}
              </span>
              <ChevronDownIcon className="max-[767px]:hidden w-3.5 h-3.5 ml-[30px]" />
            </Button>
          </main>
        </nav>
      )}
      {!showLeftSidebar && (
        <nav className="h-screen w-[90px] max-[991px]:hidden flex flex-col bg-background-primary">
          {/* Header */}
          <header className="mt-[25px] ml-[28px]">
            <svg
              width="30"
              height="30"
              viewBox="0 0 30 30"
          ...
          {/* Main Navigation */}
          <main className="flex flex-col flex-1 items-center mt-[27px]">
            <section className="w-full space-y-2">
              {/* Users Management button - active state */}
              <Link to="/">
                <button
            ...
            <Button
              variant="ghost"
              className="mt-auto mb-4  h-11 gap-3 pl-4 pr-2 py-3 bg-[#FAF6F5] rounded-[14px]"
            >
              <LogOutIcon className="w-5 h-5" />
            </Button>
          </main>
      ...
      <div className="m-[10px] h-screen">
        {/* زر الهامبرجر يظهر فقط على الموبايل */}
        <button
          className={`hidden max-[991px]:block  ${
            open ? "fixed left-0 pl-[9px] w-[223px] z-50" : ""
          } bg-[white]`}
        ...
        <div
          className={`
            hidden max-[991px]:block
          fixed top-[33px] left-0 h-full w-[223px] bg-white shadow-lg transform 
          transition-transform duration-300 z-40
          ${open ? "translate-x-0" : "-translate-x-full"} 
          xl:translate-x-0 xl:static
        `}
        >
          <nav className=" flex flex-col bg-background-primary h-full">
            {/* Header */}
            <header className="flex items-center gap-[7px] mt-[15px] ml-[28px]">
              <svg
                width="30"
                height="30"
                viewBox="0 0 30 30"
            ...
            {/* Main Navigation */}
            <main className="flex flex-col flex-1 items-center mt-[27px] p-[9px] w-[223px]">
              <section className="w-full space-y-2">
                {/* Users Management button - active state */}
                <Link to="/">
                  <button
              ...
              <Button
                variant="ghost"
                className="mt-auto mb-[30px] h-11 gap-3 pl-4 pr-2 py-3 bg-bg rounded-[14px] justify-start"
              >
                <LogOutIcon className="w-5 h-5" />
