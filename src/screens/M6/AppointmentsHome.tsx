...
export const Appointments = ({}: SidebarProps): JSX.Element => {
          ...
          {showRightSidebar && (
            ...
            >
              <CardContent className="w-full h-full pt-[20px] pl-[6px] pr-[8px]">
                <header className="flex flex-wrap justify-between w-full max-[767px]:flex-col max-[991px]:gap-[5px]">
