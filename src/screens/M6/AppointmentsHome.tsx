    ...
    <div className="flex h-screen  w-screen">
      ...
      <>
        <div className="flex flex-col w-full overflow-hidden items-start gap-4 py-4 pl-0 pr-5">
          <Header MainTitle="Appointments" SubTitle="" onOpenSidebar={onOpenSidebar} />
          
     


          <div
            className={` ${showRightSidebar
              ...
              >
                <CardContent className="w-full h-full pt-[20px] pl-[6px] pr-[8px]">
                  ...
                  {selected === "All Clinics" && (
                    <div className="relative mt-[16px] grid grid-cols-[1fr_2fr_2fr_2fr_2fr_2fr] gap-y-[16px] gap-x-[8px] items-center">
                      ...
                      <div className="p-[4px] flex flex-col gap-[6px] border border-border-light rounded-[8px]">
                        ...
                        <CardInAll className="bg-[#69A3E9]" />
                        <AddCardInAll addPatient={addPatient.addPatient2}
                          handelAddClick={() =>
                            setAddPatient({
                              addPatient1: false,
                              addPatient2: true,
                  ...
                  <div
                    ...
                    className={`w-[24px] h-[24px] flex items-center justify-center absolute rounded-[20px] text-[#B8B1A9] top-[500px] right-[0px] ${showRightSidebar ? "" : "rotate-180"
                  ...
                  <div
                    ...
                    className={`w-[24px] h-[24px] flex items-center justify-center absolute rounded-[20px] text-[#B8B1A9] top-[500px] left-[0px] ${isOpenAppointment ? "" : "rotate-180"
                      }  hover:bg-[#D4D4D4] hover:text-[#141B34] transition duration-2000`}
                  >
                    <svg
                      width="16"
            ...
            {!showRightSidebar && (
              ...
              >
                <CardContent className="w-full  h-full pt-[20px] pl-[6px] pr-[8px]">
                  ...
                  <div
                    onClick={() => setShowRightSidebar(!showRightSidebar)}
                    className={`w-[24px] h-[24px] flex items-center justify-center absolute rounded-[20px] text-[#B8B1A9] top-[500px] right-[0] ${showRightSidebar ? "" : "rotate-180"
                      }  hover:bg-[#D4D4D4] hover:text-[#141B34] transition duration-2000`}
                  >
                    <svg
                      width="16"
                  ...
                  <div
                    onClick={() => setIsOpen(!isOpenAppointment)}
                    className={`w-[24px] h-[24px] flex items-center justify-center absolute rounded-[20px] text-[#B8B1A9] top-[500px] left-[0] ${isOpenAppointment ? "" : "rotate-180"
                      }  hover:bg-[#D4D4D4] hover:text-[#141B34] transition duration-2000`}
                  >
                    <svg
                      width="16"
                    ...
                    >
                      <div className="flex w-full items-center justify-between mb-[12px] ">
                        ...
                        <ChevronDownIcon
                          ...
                          className={`transition-transform duration-200 ${open.services ? "rotate-180" : "rotate-0"
                            }`}
                        />
                      </div>
                    </Button>
                  ...
                  <CollapsibleTrigger asChild>
                    ...
                    >
                      <div className="flex w-full items-center justify-between mb-[12px] ">
                        ...
                        <ChevronDownIcon
                          style={{ width: "16px", height: "16px" }}
                          className={`transition-transform duration-200 ${open.onGoingAppointment ? "rotate-180" : "rotate-0"
                            }`}
                        />
                      </div>
                    </Button>
                  ...
                  <CollapsibleTrigger asChild>
                    ...
                    >
                      <div className="flex w-full items-center justify-between mb-[12px] ">
                        ...
                        <ChevronDownIcon
                          style={{ width: "16px", height: "16px" }}
                          className={`transition-transform duration-200 ${open.upcomingAppointments ? "rotate-180" : "rotate-0"
                            }`}
                        />
                      </div>
                    </Button>
