...
import { NavigationSidebarSection1 } from "../../testt";
...
import RegisterWizard from "../test";
...
export const CompanyPlan = (): JSX.Element => {
  ...
  return (
    <div className="flex h-screen w-screen overflow-hidden">
      ...
      {currentStep === 2 && <CompanyDetailsSection handleNext={handleNext} prevStep={prevStep} />}
      {currentStep === 3 && <ContactInfoSection handleNext={handleNext} prevStep={prevStep}/>}
      {currentStep === 4 && <LegalDetailsSection handleNext={handleNext} prevStep={prevStep}/>}
