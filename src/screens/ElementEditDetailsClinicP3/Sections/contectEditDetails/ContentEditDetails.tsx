  ...
  return (
    ...
    lg:w-[200px] lg:h-[40px]  rounded-[20px] bg-secondary-dark font-lato font-medium text-sm leading-[100%] tracking-[0] text-surface-primary">
            ...
            <ReusableCollapsible
              ...
              text-text-primary font-sans border-border-light  border-border-light text-[clamp(12px,1.1vw,14px)]"
                      />
                    </div>
                ...
                <div className=" flex gap-x-[123px]  flex-wrap  " >
                  ...
                  <div className="flex flex-col sm:flex-row lg:items-start sm:items-center gap-y-2 gap-x-4  w-full sm:w-[520px]">
                    ...
                    <div className="flex items-center mt-2 gap-2 min-w-[180px] sm:justify-start">
                      ...
                      <span className="text-text-primary  font-semiboldtext-[clamp(14px,1.1vw,16px)]">
                        {t("Email")}:
                      </span>
                    </div>
      ...
      text-text-primary font-sans"
                ...
                <div className="flex flex-col md:flex-row md:items-start lg:items-start   gap-3">
                  <div className="flex w-[186px] items-center gap-4 mt-2">
                    ...
                    <div className="min-w-[160px] text-text-primary font-semiboldtext-[clamp(14px,1.1vw,16px)]">
                      {t("Physical Address")}:
                    </div >
                  </div>
                 ...
                 text-text-primary font-sans"
                  ...
                  <div className="flex flex-col sm:flex-row sm:items-center w-full sm:w-[520px] gap-y-2 gap-x-10">
                    ...
                    <div className="flex items-center gap-2 w-full sm:w-[160px]">
                      ...
                      <span className="text-text-primary min-w-[160px] font-semiboldtext-[clamp(14px,1.1vw,16px)]">
                        {t("Maps Location")}:
                      </span>
                    </div>
                    ...
                    {socialMediaData.map((social, index) => (
                      ...
                      >
                        ...
                        <div className="flex items-center gap-2   w-[min(100%,166px)] h-6">
                          ...
                          <span className="text-text-primary font-semibold text-[clamp(14px,1.1vw,16px)] leading-6">
                            {social.platform}:
                          </span>
                        </div>
                    ...
                    <Table className="min-w-[700px]">
                      <TableHeader>
                        <TableRow>
                          ...
                          <TableHead className="w-[225px] text-center font-semibold text-text-primary  text-[clamp(14px,2vw,16px)] ">
                            {t("Clinic")}
                          </TableHead>
                      ...
                      <TableBody>
                        {doctorsAndStaff.map((person) => (
                          ...
                          >
                            ...
                            <TableCell className="text-center font-medium text-[clamp(14px,2vw,16px)] ">
                              {person.clinic}
                            </TableCell>
                            <TableCell className="text-center font-medium text-[clamp(14px,2vw,16px)] ">
                              {person.userType}
